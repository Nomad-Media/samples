...
METHOD: GET`);try{var s=await fetch(r,{method:"GET",headers:t});if(s.ok)return await s.json();throw await s.json()}catch(e){_apiExceptionHandler(e,"Get Content Failed")}}async function _updateContent(e,t,i,n,a,o,r){var s=t+"/content/"+i,l=new Headers,c=(l.append("Content-Type","application/json"),l.append("Authorization","Bearer "+e),await _getContent(e,t,i,n,null,r));if(c.contentDefinitionId!==n&&(c.contentDefinitionId=n),c.contentId!==i&&c.languageId!==o)for(const d in a)c[d]!==a[d]&&(c[d]=a[d]);r&&console.log(`URL: ${s}
METHOD: PUT
