...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var p=await fetch(t,{method:"POST",headers:c,body:JSON.stringify(e)});if(p.ok)return await p.json();throw await p.json()}catch(e){_apiExceptionHandler(e,"Adding Tag or Collection Failed")}}async function _deleteRelatedContent(e,t,i,n,a,o){var t=t+"/admin/related/delete",r=new Headers,e=(r.append("Content-Type","application/json"),r.append("Authorization","Bearer "+e),{items:[{contentDefinition:a,contentId:i,relatedContentId:n}]});o&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: GET`);try{var s=await fetch(r,{method:"GET",headers:t});if(s.ok)return await s.json();throw await s.json()}catch(e){_apiExceptionHandler(e,"Get Content Failed")}}async function _updateContent(e,t,i,n,a,o,r){var t=t+"/content/"+i,s=new Headers,e=(s.append("Content-Type","application/json"),s.append("Authorization","Bearer "+e),{contentDefinitionId:n,contentId:i,properties:a,languageId:o});r&&console.log(`URL: ${t}
METHOD: PUT
BODY: `+JSON.stringify(e,null,4));try{var l=await fetch(t,{method:"PUT",headers:s,body:JSON.stringify(e)});if(l.ok)return await l.json();throw await l.json()}catch(e){_apiExceptionHandler(e,"Update Content Failed")}}async function _addLiveScheduleToEvent(e,t,i,n,a,o,r,s,l,c,p,d,h,u){var t=t+"/admin/liveSchedule",f=new Headers,e=(f.append("Content-Type","application/json"),f.append("Authorization","Bearer "+e),{contentId:i,slateVideo:null!==n?n:"",prerollVideo:null!==a?a:"",postrollVideo:null!==o?o:"",isSecureOutput:null!==r&&r,archiveFolderAsset:null!==s?s:"",primaryLiveInput:null!==l?l:"",backupLiveInputId:null!==c?c:"",primaryLivestreamInputUrl:null!==p?p:"",backupLivestreamInputUrl:null!==d?d:"",externalOutputProfiles:null!==h?h:""});u&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var g=await fetch(t,{method:"POST",headers:f,body:JSON.stringify(e)});if(!g.ok)throw await g.json()}catch(e){_apiExceptionHandler(e,"Adding Live Schedule to Event Failed")}}async function _createAndUpdateEventInstance(e,t,i,n,a,o,r,s,l,c,p,d,h,u,f,g,w,y,v,m,_,T,E,D,S,O,C,L,A,k){var t=t+"/content/"+(i=null===i?_newGuid():i),U=new Headers,e=(U.append("Content-Type","application/json"),U.append("Authorization","Bearer "+e),{contentId:i,contentDefinitionId:n,properties:{contentRatings:null!==C?C:"",disabled:null!==L&&L,endDatetime:s,externalUrl:null!==g?g:"",featuredGroups:null!==E?E:[],genres:null!==v?v:[],groupSequence:null!==D?D:"",heroImage:null!==h?h:"",intelligentProgram:null!==f?f:"",languages:null!==_?_:[],liveChannel:null!==A?A:"",logoImage:null!==u?u:"",longDescription:null!==p?p:"",mediaAttributes:null!==m?m:[],name:a,performers:null!==y?y:[],primaryPerformer:null!==l?l:"",products:null!==T?T:[],recommendedSimilarItems:null!==O?O:[],relatedMediaItems:null!==S?S:[],routeName:_slugify(a),series:null!==o?o:"",shortDescription:null!==c?c:"",startDatetime:r,thumbnailImage:null!==d?d:"",venue:null!==w?w:""}});k&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var b=await fetch(t,{method:"POST",headers:U,body:JSON.stringify(e)});if(b.ok)return await b.json();throw await b.json()}catch(e){_apiExceptionHandler(e,"Create and Update Event Instance Failed")}}async function _deleteEventInstance(e,t,i,n,a){t=t+`/content/${i}?contentDefinitionId=`+n,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: DELETE`);try{var o=await fetch(t,{method:"DELETE",headers:i});if(!o.ok)throw await o.json()}catch(e){_apiExceptionHandler(e,"Delete Event Instance Failed")}}async function _extendLiveSchedule(e,t,i,n,a,o,r){t+=`/admin/liveSchedule/content/${i}/copy`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={endDate:null!==o?o:"",recurringDays:n,recurringWeeks:a,timeZoneOffsetSeconds:-60*(new Date).getTimezoneOffset()};r&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: POST`);try{var a=await fetch(t,{method:"POST",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Stop Live Schedule Failed")}}async function _createLiveChannel(e,t,i,n,a,o,r,s,l,c,p,d,h){var u=t+"/liveChannel",f=new Headers,i=(f.append("Content-Type","application/json"),f.append("Authorization","Bearer "+e),{name:i,routeName:_slugify(i),enableHighAvailability:o,enableLiveClipping:r,isSecureOutput:s,outputScreenshots:l,type:{id:_LIVE_CHANNEL_TYPES[c],descrption:c}});n&&(i.thumbnailImage={id:n}),a&&(i.archiveFolderAsset={id:a}),"External"===c&&(i.externalUrl=p),d&&(o=await _getSecurityGroups(e,t,h),i.securityGroups=o.filter(e=>d.includes(e.description)).map(e=>({description:e.description,id:e.id}))),h&&console.log(`URL: ${u}
METHOD: POST
BODY: `+JSON.stringify(i,null,4));try{var g,w=await fetch(u,{method:"POST",headers:f,body:JSON.stringify(i)});if(w.ok)return await _waitForLiveChannelStatus(e,t,(g=await w.json()).id,_LIVE_CHANNEL_STATUSES.Idle,120,2,h),g;throw await w.json()}catch(e){_apiExceptionHandler(e,"Create Live Channel Failed")}}async function _deleteLiveChannel(t,e,i,n,a){e=e+"/liveChannel/"+i;let o=null;o=!0===n?(a&&console.log("Getting Live Channel Inputs IDs..."),await _getLiveChannelInputsIds(t,i)):null;i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+t),a&&console.log(`URL: ${e}
...
METHOD: POST`);try{var r=await fetch(a,{method:"POST",headers:o});if(!r.ok)throw await r.json();await _waitForLiveChannelStatus(e,t,i,_LIVE_CHANNEL_STATUSES.Idle,1200,20,n)}catch(e){_apiExceptionHandler(e,"Stop Live Channel Failed")}}async function _updateLiveChannel(e,t,i,n,a,o,r,s,l,c,p,d,h,u){var i=await _getLiveChannel(e,t,i,u),f=t+"/liveChannel",g=new Headers;g.append("Content-Type","application/json"),g.append("Authorization","Bearer "+e);n&&n!==i.name&&(i.name=n,i.routeName=_slugify(n)),a&&a!==i.thumbnailImage&&(i.thumbnailImage={id:a}),o&&o!==i.archiveFolderAsset.id&&(i.archiveFolderAsset={id:o}),r&&r!==i.enableHighAvailability&&(i.enableHighAvailability=r),s&&s!==i.enableLiveClipping&&(i.enableLiveClipping=s),l&&l!==i.isSecureOutput&&(i.isSecureOutput=l),c&&c!==i.outputScreenshots&&(i.outputScreenshots=c),p&&_LIVE_CHANNEL_STATUSES[p]!==i.type.id&&(i.type={id:_LIVE_CHANNEL_TYPES[p]}),"External"===p?d&&d!==i.externalUrl&&(i.externalUrl=d):d&&i.externalUrl&&delete i.externalUrl,h&&(n=(await _getSecurityGroups(e,t,u)).filter(e=>h.includes(e.description)).map(e=>({description:e.description,id:e.id})))!==i.securityGroups&&(i.securityGroups=n),u&&console.log(`URL: ${f}
METHOD: POST
BODY: `+JSON.stringify(i,null,4));try{var w,y=await fetch(f,{method:"PUT",headers:g,body:JSON.stringify(i)});if(y.ok)return await _waitForLiveChannelStatus(e,t,(w=await y.json()).id,_LIVE_CHANNEL_STATUSES.Idle,120,2,u),w;throw await y.json()}catch(e){_apiExceptionHandler(e,"Updating Live Channel Failed")}}async function _waitForLiveChannelStatus(e,t,i,n,a=30,o=2,r){var s=(new Date).getTime();let l=0;for(;l<a;){var c=await _getLiveChannelStatus(e,t,i,r);if(c===n)return void(r&&console.log(`Live Channel [${i}] transitioned to status [${n}]`));if(console.log(`Live Channel [${i}] current status is [${c}]`),"Error"===c)throw c=await _getLiveChannelStatusMessage(e,t,i,r),new Error(`Live Channel [${i}] is in [Error] status: `+c);if(l=((new Date).getTime()-s)/1e3,r&&console.log(`Waiting for Live Channel [${i}] to transition to status [${n}]... [${Math.round(l)}/${a}]`),l>a)break;await _sleep(o)}throw new Error(`Waiting for Live Channel [${i}] to transition to status [${n}] timed out`)}async function _createLiveInput(e,t,i,n,a,o,r,s,l,c){var p=t+"/liveInput",d=new Headers,i=(d.append("Content-Type","application/json"),d.append("Authorization","Bearer "+e),{name:i,internalName:_slugify(i),type:{id:_LIVE_INPUT_TYPES[a],description:a}});"RTMP_PUSH"==a?n&&(i.sourceCidr=n):"RTMP_PULL"!==a&&"RTP_PUSH"!==a&&"URL_PULL"!==a||n&&(i.sources=[{url:n}]),o&&(i.isStandard=o),r&&(i.videoAsset={id:r}),s&&(i.destinations=s),l&&(i.sources=l),c&&console.log(`URL: ${p}
METHOD: POST
...
METHOD: POST`);try{var r=await fetch(a,{method:"POST",headers:o});if(!r.ok)throw await r.json();await _waitForLiveOperatorStatus(e,t,i,"Idle",1200,20)}catch(e){_apiExceptionHandler(e,"Stop Broadcast Failed")}}async function _waitForLiveOperatorStatus(e,t,i,n,a=30,o=2,r){var s=(new Date).getTime();let l=0;for(;l<a;){var c=(await _getLiveOperator(e,t,i,r)).liveChannelStatus.description;if(c===n)return void(r&&console.log(`Live Operator ${i} transitioned to status `+n));if(console.log(`Live Operator [${i}] is in status [${c}]`),"Error"===c)throw new Error(`Live Operator ${i} is broken`);if(l=((new Date).getTime()-s)/1e3,r&&console.log(`Waiting for Live Operator [${i}] to transition to status [${n}]... [${Math.round(l)}/${a}]`),l>a)break;await _sleep(o)}throw new Error(`Waiting for Live Operator [${i}] to transition to status [${n}] timed out`)}async function _addAssetScheduleEvent(e,t,i,n,a,o,r,s,l,c){var t=t+`/LiveChannel/${n}/liveScheduleEvent`,p=new Headers,e=(p.append("Content-Type","application/json"),p.append("Authorization","Bearer "+e),{id:i,isLoop:r,channelId:n,durationTimeCode:s,previousId:l,type:{id:_eventType.videoAsset,description:"Video Asset"},asset:{id:a,description:o}});c&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var d=await fetch(t,{method:"POST",headers:p,body:JSON.stringify(e)});if(d.ok)return(await d.json()).changeList[0];throw await d.json()}catch(e){_apiExceptionHandler(e,"Adding Asset Schedule Event Failed")}}async function _addInputScheduleEvent(e,t,i,n,a,o,r,s,l,c){var t=t+`/LiveChannel/${i}/liveScheduleEvent`,p=new Headers,e=(p.append("Content-Type","application/json"),p.append("Authorization","Bearer "+e),{channelId:i,fixedOnAirTimeUtc:s,type:{id:_eventType.liveInput,description:"Live Input"},liveInput:{id:n,description:a},previousId:l});o&&(e.liveInput2={id:o,description:r}),c&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var d=await fetch(t,{method:"POST",headers:p,body:JSON.stringify(e)});if(d.ok)return(await d.json()).changeList[0];throw await d.json()}catch(e){_apiExceptionHandler(e,"Adding Input Schedule Event Failed")}}const _eventType={liveInput:"eef7ef23-56dc-4f48-8c0e-1f4d52990405",videoAsset:"eef7ef23-56dc-4f48-8c0e-1f4d52990404"};async function _removeAssetScheduleEvent(e,t,i,n,a){t=t+`/LiveChannel/${i}/liveScheduleEvent/`+n,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
...
METHOD: POST
BODY: `+JSON.stringify(t,null,4));try{var r=await fetch(e,{method:"POST",headers:o,body:JSON.stringify(t)});if(!r.ok)throw await r.json()}catch(e){_apiExceptionHandler(e,"Reset Password Failed")}}async function _search(e,t,i,n,a,o,r,s,l,c,p,d,h,u){t+=`/${h}/search`,h=new Headers,h.append("Content-Type","application/json"),h.append("Authorization","Bearer "+e),e={};i&&(e.query=i),e.pageOffset=n||0,e.pageSize=a||100,o&&(e.filters=o),r&&(e.sortFields=r),s&&(e.resultFields=s),l&&(e.similarAssetId=l),c&&(e.minScore=c),p&&(e.excludeTotalRecordCount=p),d&&(e.filterBinder=d),u&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var f=await fetch(t,{method:"POST",headers:h,body:JSON.stringify(e)});if(f.ok)return await f.json();throw await f.json()}catch(e){_apiExceptionHandler(e,"Search Failed")}}function _apiExceptionHandler(t,i){if(!t)throw new Error(i);if("string"==typeof t)throw new Error(i+": "+t);if(!t.errors)throw new Error(i+": "+t.message);if(Array.isArray(t.errors)){let e="";for(var n in t.errors)Object.prototype.hasOwnProperty.call(t.errors,n)&&(e+=`${n}: ${t.errors[n]}\n`);throw new Error(i+": "+e)}if("object"==typeof t.errors){let e="";for(var a in t.errors)Object.prototype.hasOwnProperty.call(t.errors,a)&&(e+=`${a}: ${t.errors[a]}\n`);throw new Error(i+": "+e)}}import{getRandomValues}from"crypto";function _newGuid(){return([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(e^getRandomValues(new Uint8Array(1))[0]&15>>e/4).toString(16))}function _printDatetime(e){var t=(new Date).toLocaleTimeString();console.log(t+": "+e)}async function _sleep(t){if(t&&0!==t)return new Promise(e=>{setTimeout(()=>{e()},1e3*t)})}function _slugify(e){return e&&0!==e.trim().length?e.toString().normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim().replace(/\s+/g,"-").replace(/[^\w-]+/g,"").replace(/--+/g,"-"):""}async function _changeEmail(e,t,i,n,a){var t=t+"/account/change-email",o=new Headers,e=(o.append("Content-Type","application/json"),o.append("Authorization","Bearer "+e),{password:n,newEmail:i});a&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:n});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get user failed")}}async function _updateUser(e,t,i,n,a,o,r,s,l,c,p,d,h,u){var f,g=await _getUser(e,t,u),w=t+"/account/user",y=new Headers,v=(y.append("Content-Type","application/json"),y.append("Authorization","Bearer "+e),{}),e=_getCountries(t,u).find(e=>e.name===o),m={address:i,address2:n,city:a,stateId:_getStates(t,u).find(e=>e.name===h),country:e,firstName:r,lastName:s,phone:c,phoneExt:p,postalCode:d,organization:l};for(const T in m)null!==m[T]?v[T]=m[T]:null!=(f=g[T])&&(v[T]=f);u&&console.log(`URL: ${w}
METHOD: PUT
BODY: `+JSON.stringify(v,null,4));try{var _=await fetch(w,{method:"PUT",headers:y,body:JSON.stringify(v)});return _.ok||await _.json(),await _.json()}catch(e){_apiExceptionHandler(e,"Update user failed")}}async function _addContentsToContentGroup(e,t,i,n,a){t=t+"/contentgroup/add/"+i,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e=n;a&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var o=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(o.ok)throw await o.json();return await o.json()}catch(e){_apiExceptionHandler(e,"Creating Form Failed")}}async function _mediaSearch(e,t,i,n,a,o,r,s,l){var t=t+"/media/search",c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),{searchQuery:i,ids:n,sortFields:[{fieldName:a,sortType:o}]});e.pageOffset=r||0,e.pageSize=s||100,l&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var p=await fetch(t,{method:"POST",headers:c,body:JSON.stringify(e)});if(p.ok)throw await p.json();return await p.json()}catch(e){_apiExceptionHandler(e,"Media Search Failed")}}async function _getVideoTracking(e,t,i,n,a,o){let r=t+"/asset/tracking?assetId="+i;t=new Headers;t.append("Content-Type","application/json"),t.append("Authorization","Bearer "+e),n&&(r+="&trackingEvent="+n),a&&(r+="&second="+a),o&&console.log(`URL: ${r}
METHOD: GET`);try{var s=await fetch(r,{method:"GET",headers:t});if(s.ok)return await s.json();throw await s.json()}catch(e){_apiExceptionHandler(e,"Get Video Tracking Failed")}}