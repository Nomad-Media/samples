...
METHOD: POST`);try{var a=await fetch(t,{method:"POST",headers:i});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Cancel asset upload failed")}}const MAX_CONCURRENT_PROMISES=8;async function _multiThreadUpload(n,a,o,e,r){var t=e.parts;const s=t.length;for(let e=0;e<s;e+=MAX_CONCURRENT_PROMISES){var i=t.slice(e,e+MAX_CONCURRENT_PROMISES).map(async(e,t)=>{console.log(`Uploading part ${t+1} of ${s}...`);var i=await _uploadPart(o,e,r);await _uploadPartComplete(n,a,e.id,i,r),console.log(`Uploaded part ${t+1} of ${s} successfully`)});await Promise.all(i)}}async function _startUpload(e,t,i,n,a,o,r,s,l,p,c,d){t+="/asset/upload/start";let h=p.size/1e4;h<20971520&&(h=20971520);var u=new Headers,e=(u.append("Content-Type","application/json"),u.append("Authorization","Bearer "+e),{displayName:i||p.originalname,contentLength:p.size,uploadOverwriteOption:l,relativePath:p.originalname,parentId:c,chunkSize:h,relatedContentId:r,languageId:s,existingAssetId:n,relatedAssetId:a,createTranscribeRelatedAsset:o});d&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var s=await fetch(t,{method:"POST",headers:r,body:JSON.stringify(e)});if(s.ok)return await s.json();throw await s.json()}catch(e){_apiExceptionHandler(e,"Adding Related Content Failed")}}async function _addTagOrCollection(e,t,i,n,a,o,r,s,l){var t=t+`/admin/${i}/content`,p=new Headers,e=(p.append("Content-Type","application/json"),p.append("Authorization","Bearer "+e),{items:[{contentDefinition:a,contentId:n,name:o,createNew:s}]});null!=r&&(e.items[0][i+"Id"]=r),l&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var c=await fetch(t,{method:"POST",headers:p,body:JSON.stringify(e)});if(c.ok)return await c.json();throw await c.json()}catch(e){_apiExceptionHandler(e,"Adding Tag or Collection Failed")}}async function _createTagOrCollection(e,t,i,n,a){t=t+"/admin/"+i,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={name:n};a&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: GET`);try{var s=await fetch(r,{method:"GET",headers:t});if(s.ok)return await s.json();throw await s.json()}catch(e){_apiExceptionHandler(e,"Get Content Failed")}}import deepEqual from"deep-equal";async function _updateContent(e,t,i,n,a,o,r){var s=t+"/content/"+i,l=new Headers;l.append("Content-Type","application/json"),l.append("Authorization","Bearer "+e);let p=null;try{(p=await _getContent(e,t,i,n,null,r)).contentDefinitionId!==n&&(p.contentDefinitionId=n),p.contentId!==i&&(p.contentId=i),p.languageId!==o&&(p.languageId=o),_updateProperties(p,a)}catch(e){p={contentDefinitionId:n,contentId:i,languageId:o,properties:a}}r&&console.log(`URL: ${s}
METHOD: PUT
BODY: `+JSON.stringify(p,null,4));try{var c=await fetch(s,{method:"PUT",headers:l,body:JSON.stringify(p)});if(c.ok)return await c.json();throw await c.json()}catch(e){_apiExceptionHandler(e,"Update Content Failed")}}function _updateProperties(t,i){for(const n in i)if(Array.isArray(i[n]))for(let e=0;e<i[n].length;++e)deepEqual(t.properties[n][e],i[n][e])||(t.properties[n][e]=i[n][e]);else"object"==typeof i[n]?deepEqual(t.properties[n],i[n])||(t.properties[n]=i[n]):t.properties[n]!==i[n]&&(t.properties[n]=i[n])}async function _addLiveScheduleToEvent(e,t,i,n,a,o,r,s,l,p,c,d,h,u){var t=t+"/admin/liveSchedule",f=new Headers,e=(f.append("Content-Type","application/json"),f.append("Authorization","Bearer "+e),{contentId:i,slateVideo:null!==n?n:"",prerollVideo:null!==a?a:"",postrollVideo:null!==o?o:"",isSecureOutput:null!==r&&r,archiveFolderAsset:null!==s?s:"",primaryLiveInput:null!==l?l:"",backupLiveInputId:null!==p?p:"",primaryLivestreamInputUrl:null!==c?c:"",backupLivestreamInputUrl:null!==d?d:"",externalOutputProfiles:null!==h?h:""});u&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var g=await fetch(t,{method:"POST",headers:f,body:JSON.stringify(e)});if(!g.ok)throw await g.json()}catch(e){_apiExceptionHandler(e,"Adding Live Schedule to Event Failed")}}async function _createAndUpdateEvent(e,t,i,n,a,o,r,s,l,p,c,d,h,u,f,g,w,y,v,m,_,T,E,D,S,O,C,L,A,U){var k=new Headers;if(k.append("Content-Type","application/json"),k.append("Authorization","Bearer "+e),null===i){e=t+"/content/new?contentDefinitionId="+n;U&&console.log(`URL: ${e}
METHOD: GET`);try{var b=await fetch(e,{method:"GET",headers:k});if(!b.ok)throw await b.json();i=(await b.json()).contentId}catch(e){_apiExceptionHandler(e,"Get Content ID Failed")}}e=t+"/content/"+i,b={contentId:i,contentDefinitionId:n,properties:{contentRatings:null!==C?C:"",disabled:null!==L&&L,endDatetime:s,externalUrl:null!==g?g:"",featuredGroups:null!==E?E:[],genres:null!==v?v:[],groupSequence:null!==D?D:"",heroImage:null!==h?h:"",intelligentProgram:null!==f?f:"",languages:null!==_?_:[],liveChannel:null!==A?A:"",logoImage:null!==u?u:"",longDescription:null!==c?c:"",mediaAttributes:null!==m?m:[],name:a,performers:null!==y?y:[],primaryPerformer:null!==l?l:"",products:null!==T?T:[],recommendationSimilarItems:null!==O?O:[],relatedMediaItems:null!==S?S:[],routeName:_slugify(a),series:null!==o?o:"",shortDescription:null!==p?p:"",startDatetime:r,thumbnailImage:null!==d?d:"",venue:null!==w?w:""}};U&&console.log(`URL: ${e}
METHOD: PUT
BODY: `+JSON.stringify(b,null,4));try{var H=await fetch(e,{method:"PUT",headers:k,body:JSON.stringify(b)});if(H.ok)return await H.json();throw await H.json()}catch(e){_apiExceptionHandler(e,"Create and Update Event Instance Failed")}}async function _deleteEvent(e,t,i,n,a){t=t+`/content/${i}?contentDefinitionId=`+n,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
...
METHOD: POST`);try{var a=await fetch(t,{method:"POST",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Stop Live Schedule Failed")}}async function _createLiveChannel(e,t,i,n,a,o,r,s,l,p,c,d,h,u){var f=t+"/liveChannel",g=new Headers,i=(g.append("Content-Type","application/json"),g.append("Authorization","Bearer "+e),{name:i,routeName:_slugify(i),enableHighAvailability:o,enableLiveClipping:r,externalOutputProfiles:d,isSecureOutput:s,outputScreenshots:l,type:{id:_LIVE_CHANNEL_TYPES[p],descrption:p}});n&&(i.thumbnailImage={id:n}),a&&(i.archiveFolderAsset={id:a}),"External"===p&&(i.externalUrl=c),h&&(o=await _getSecurityGroups(e,t,u),i.securityGroups=o.filter(e=>h.includes(e.description)).map(e=>({description:e.description,id:e.id}))),u&&console.log(`URL: ${f}
METHOD: POST
...
METHOD: POST`);try{var r=await fetch(a,{method:"POST",headers:o});if(!r.ok)throw await r.json();await _waitForLiveChannelStatus(e,t,i,_LIVE_CHANNEL_STATUSES.Idle,1200,20,n)}catch(e){_apiExceptionHandler(e,"Stop Live Channel Failed")}}async function _updateLiveChannel(e,t,i,n,a,o,r,s,l,p,c,d,h,u,f){var i=await _getLiveChannel(e,t,i,f),g=t+"/liveChannel",w=new Headers;w.append("Content-Type","application/json"),w.append("Authorization","Bearer "+e);n&&n!==i.name&&(i.name=n,i.routeName=_slugify(n)),a&&a!==i.thumbnailImage&&(i.thumbnailImage={id:a}),o&&o!==i.archiveFolderAsset.id&&(i.archiveFolderAsset={id:o}),r&&r!==i.enableHighAvailability&&(i.enableHighAvailability=r),s&&s!==i.enableLiveClipping&&(i.enableLiveClipping=s),l&&l!==i.isSecureOutput&&(i.isSecureOutput=l),p&&p!==i.outputScreenshots&&(i.outputScreenshots=p),c&&_LIVE_CHANNEL_STATUSES[c]!==i.type.id&&(i.type={id:_LIVE_CHANNEL_TYPES[c]}),h&&h!==i.externalOutputProfiles&&(i.externalOutputProfiles=h),"External"===c?d&&d!==i.externalUrl&&(i.externalUrl=d):d&&i.externalUrl&&delete i.externalUrl,u&&(n=(await _getSecurityGroups(e,t,f)).filter(e=>u.includes(e.description)).map(e=>({description:e.description,id:e.id})))!==i.securityGroups&&(i.securityGroups=n),f&&console.log(`URL: ${g}
METHOD: POST
BODY: `+JSON.stringify(i,null,4));try{var y,v=await fetch(g,{method:"PUT",headers:w,body:JSON.stringify(i)});if(v.ok)return await _waitForLiveChannelStatus(e,t,(y=await v.json()).id,_LIVE_CHANNEL_STATUSES.Idle,120,2,f),y;throw await v.json()}catch(e){_apiExceptionHandler(e,"Updating Live Channel Failed")}}async function _waitForLiveChannelStatus(e,t,i,n,a=30,o=2,r){var s=(new Date).getTime();let l=0;for(;l<a;){var p=await _getLiveChannelStatus(e,t,i,r);if(p===n)return void(r&&console.log(`Live Channel [${i}] transitioned to status [${n}]`));if(console.log(`Live Channel [${i}] current status is [${p}]`),"Error"===p)throw p=await _getLiveChannelStatusMessage(e,t,i,r),new Error(`Live Channel [${i}] is in [Error] status: `+p);if(l=((new Date).getTime()-s)/1e3,r&&console.log(`Waiting for Live Channel [${i}] to transition to status [${n}]... [${Math.round(l)}/${a}]`),l>a)break;await _sleep(o)}throw new Error(`Waiting for Live Channel [${i}] to transition to status [${n}] timed out`)}async function _createLiveInput(e,t,i,n,a,o,r,s,l,p){var c=t+"/liveInput",d=new Headers,i=(d.append("Content-Type","application/json"),d.append("Authorization","Bearer "+e),{name:i,internalName:_slugify(i),type:{id:_LIVE_INPUT_TYPES[a],description:a}});"RTMP_PUSH"==a?n&&(i.sourceCidr=n):"RTMP_PULL"!==a&&"RTP_PUSH"!==a&&"URL_PULL"!==a||n&&(i.sources=[{url:n}]),o&&(i.isStandard=o),r&&(i.videoAsset={id:r}),s&&(i.destinations=s),l&&(i.sources=l),p&&console.log(`URL: ${c}
METHOD: POST
BODY: `+JSON.stringify(i,null,4));try{var h=await fetch(c,{method:"POST",headers:d,body:JSON.stringify(i)}),u=await h.json();if(h.ok)return await _waitForLiveInputStatus(e,t,u.id,_LIVE_INPUT_STATUSES.Detached,15,1,p),u;throw await h.json()}catch(e){_apiExceptionHandler(e,"Creating Live Input Failed")}}async function _deleteLiveInput(e,t,i,n){t=t+"/liveInput/"+i,i=new Headers;i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
...
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:n});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get Live Operators Failed")}}async function _startBroadcast(e,t,i,n,a,o,r,s,l){var p=t+"/admin/liveOperator/start",c=new Headers,d=(c.append("Authorization","Bearer "+e),c.append("Content-Type","application/json"),{id:i});n&&(d.prerollAsset={id:n}),a&&(d.postrollAsset={id:a}),o&&(d.liveInput={id:o}),r&&Array.isArray(r)&&0<r.length&&(d.relatedContent=r.map(e=>({id:e}))),s&&Array.isArray(s)&&0<s.length&&(d.tags=s.map(e=>({id:e}))),l&&console.log(`URL: ${p}
METHOD: POST
BODY: `+JSON.stringify(d,null,4));try{var h=await fetch(p,{method:"POST",headers:c,body:JSON.stringify(d)});if(!h.ok)throw await h.json();await _waitForLiveOperatorStatus(e,t,i,"Running",1200,20)}catch(e){_apiExceptionHandler(e,"Start Broadcast Failed")}}async function _startSegment(e,t,i,n){t+=`/admin/liveOperator/${i}/startSegment`,i=new Headers;i.append("Authorization","Bearer "+e),i.append("Content-Type","application/json"),n&&console.log(`URL: ${t}
...
METHOD: DELETE`);try{var o=await fetch(t,{method:"delete",headers:i});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Remove Input Schedule Event Failed")}}async function _updateAssetScheduleEvent(e,t,i,n,a,o,r,s,l){var t=t+`/LiveChannel/${n}/liveScheduleEvent`,p=new Headers,e=(p.append("Content-Type","application/json"),p.append("Authorization","Bearer "+e),{id:i,isLoop:o,channelId:n,durationTimeCode:r,previousId:s,type:{id:_eventType.videoAsset,description:"Video Asset"},asset:a});l&&console.log(`URL: ${t}
METHOD: PUT
BODY: `+JSON.stringify(e,null,4));try{var c=await fetch(t,{method:"PUT",headers:p,body:JSON.stringify(e)});if(c.ok)return(await c.json()).changeList[0];throw await c.json()}catch(e){_apiExceptionHandler(e,"Adding Asset Schedule Event Failed")}}async function _updateInputScheduleEvent(e,t,i,n,a,o,r,s,l){var t=t+`/LiveChannel/${n}/liveScheduleEvent`,p=new Headers,e=(p.append("Content-Type","application/json"),p.append("Authorization","Bearer "+e),{channelId:n,fixedOnAirTimeUtc:r,id:i,type:{id:_eventType.liveInput,description:"Live Input"},liveInput:a,previousId:s});o&&(e.liveInput2=o),l&&console.log(`URL: ${t}
METHOD: PUT
BODY: `+JSON.stringify(e,null,4));try{var c=await fetch(t,{method:"PUT",headers:p,body:JSON.stringify(e)});if(c.ok)return(await c.json()).changeList[0];throw await c.json()}catch(e){_apiExceptionHandler(e,"Adding Input Schedule Event Failed")}}async function _register(e,t,i,n,a,o){var e=e+"/account/register",r=new Headers,i=(r.append("Content-Type","application/json"),{firstName:i,lastName:n,email:t,password:a});o&&console.log(`URL: ${e}
METHOD: POST
...
METHOD: GET`);try{var o=await fetch(n,{method:"GET",headers:t});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Get Asset Details Failed")}}async function _search(e,t,i,n,a,o,r,s,l,p,c,d,h,u){t+=`/${h}/search`,h=new Headers,h.append("Content-Type","application/json"),h.append("Authorization","Bearer "+e),e={};i&&(e.query=i),e.pageOffset=n||0,e.pageSize=a||100,o&&(e.filters=o),r&&(e.sortFields=r),s&&(e.searchResultFields=s),l&&(e.similarAssetId=l),p&&(e.minScore=p),c&&(e.excludeTotalRecordCount=c),d&&(e.filterBinder=d),u&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:n});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get user failed")}}async function _updateUser(e,t,i,n,a,o,r,s,l,p,c,d,h,u){var f,g=await _getUser(e,t,u),w=t+"/account/user",y=new Headers,v=(y.append("Content-Type","application/json"),y.append("Authorization","Bearer "+e),{}),m=(await _getCountries(e,t,u)).find(e=>e.label===o),_={address:i,address2:n,city:a,state:(await _getStates(e,t,u)).find(e=>e.label===h).label,country:m,firstName:r,lastName:s,phone:p,phoneExt:c,postalCode:d,organization:l};for(const E in _)null!==_[E]?v[E]=_[E]:null!=(f=g[E])&&(v[E]=f);u&&console.log(`URL: ${w}
METHOD: PUT
...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var p=await fetch(t,{method:"POST",headers:l,body:JSON.stringify(e)});if(p.ok)return await p.json();throw await p.json()}catch(e){_apiExceptionHandler(e,"Guest Invite failed")}}async function _participantPanelQuery(e,t,i,n,a){let o="";o="admin"==i?t+"/admin/user-session/"+n:t+"/user-session/"+n;i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${o}
...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var p=await fetch(t,{method:"POST",headers:l,body:JSON.stringify(e)});if(p.ok)return await p.json();throw await p.json()}catch(e){_apiExceptionHandler(e,"Remove guest failed")}}async function _createForm(e,t,i,n,a){t=t+"/media/form/"+i,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e=n;a&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var p=await fetch(t,{method:"POST",headers:l,body:JSON.stringify(e)});if(p.ok)throw await p.json();return await p.json()}catch(e){_apiExceptionHandler(e,"Media Search Failed")}}async function _getVideoTracking(e,t,i,n,a,o){let r=t+"/asset/tracking?assetId="+i;t=new Headers;t.append("Content-Type","application/json"),t.append("Authorization","Bearer "+e),n&&(r+="&trackingEvent="+n),a&&(r+="&second="+a),o&&console.log(`URL: ${r}
