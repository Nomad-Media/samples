...
METHOD: GET`);try{var o=await fetch(n,{method:"GET",headers:t});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Get Asset Details Failed")}}async function _search(e,t,i,n,a,o,r,s,l,c,p,d,h,u){t+=`/${h}/search`,h=new Headers,h.append("Content-Type","application/json"),h.append("Authorization","Bearer "+e),e={};i&&(e.query=i),e.pageOffset=n||0,e.pageSize=a||100,o&&(e.filters=o),r&&(e.sortFields=r),s&&(e.resultFields=s),l&&(e.similarAssetId=l),c&&(e.minScore=c),p&&(e.excludeTotalRecordCount=p),d&&(e.filterBinder=d),u&&console.log(`URL: ${t}
METHOD: POST
