...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var g=await fetch(t,{method:"POST",headers:f,body:JSON.stringify(e)});if(!g.ok)throw await g.json()}catch(e){_apiExceptionHandler(e,"Adding Live Schedule to Event Failed")}}async function _createAndUpdateEvent(e,t,i,n,a,o,r,s,l,c,p,d,h,u,f,g,w,y,v,m,_,T,E,D,S,O,C,L,A,k){var U=new Headers;if(U.append("Content-Type","application/json"),U.append("Authorization","Bearer "+e),null===i){e=t+"/content/new?contentDefinitionId="+n;k&&console.log(`URL: ${e}
METHOD: GET`);try{var H=await fetch(e,{method:"GET",headers:U});if(!H.ok)throw await H.json();i=(await H.json()).contentId}catch(e){_apiExceptionHandler(e,"Get Content ID Failed")}}e=t+"/content/"+i,H={contentId:i,contentDefinitionId:n,properties:{contentRatings:null!==C?C:"",disabled:null!==L&&L,endDatetime:s,externalUrl:null!==g?g:"",featuredGroups:null!==E?E:[],genres:null!==v?v:[],groupSequence:null!==D?D:"",heroImage:null!==h?h:"",intelligentProgram:null!==f?f:"",languages:null!==_?_:[],liveChannel:null!==A?A:"",logoImage:null!==u?u:"",longDescription:null!==p?p:"",mediaAttributes:null!==m?m:[],name:a,performers:null!==y?y:[],primaryPerformer:null!==l?l:"",products:null!==T?T:[],recommendationSimilarItems:null!==O?O:[],relatedMediaItems:null!==S?S:[],routeName:_slugify(a),series:null!==o?o:"",shortDescription:null!==c?c:"",startDatetime:r,thumbnailImage:null!==d?d:"",venue:null!==w?w:""}};k&&console.log(`URL: ${e}
METHOD: PUT
BODY: `+JSON.stringify(H,null,4));try{var I=await fetch(e,{method:"PUT",headers:U,body:JSON.stringify(H)});if(I.ok)return await I.json();throw await I.json()}catch(e){_apiExceptionHandler(e,"Create and Update Event Instance Failed")}}async function _deleteEvent(e,t,i,n,a){t=t+`/content/${i}?contentDefinitionId=`+n,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
...
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:i});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get Media Item Failed")}}async function _mediaSearch(e,t,i,n,a,o,r,s){var t=t+"/media/search",l=new Headers,e=(l.append("Content-Type","application/json"),l.append("Authorization","Bearer "+e),{searchQuery:i,ids:n,sortFields:a});e.pageOffset=o||0,e.pageSize=r||100,s&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var c=await fetch(t,{method:"POST",headers:l,body:JSON.stringify(e)});if(c.ok)return await c.json();throw await c.json()}catch(e){_apiExceptionHandler(e,"Media Search Failed")}}async function _getVideoTracking(e,t,i,n,a,o){let r=t+"/asset/tracking?assetId="+i;t=new Headers;t.append("Content-Type","application/json"),t.append("Authorization","Bearer "+e),n&&(r+="&trackingEvent="+n),a&&(r+="&second="+a),o&&console.log(`URL: ${r}
