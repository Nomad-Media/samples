...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var g=await fetch(t,{method:"POST",headers:f,body:JSON.stringify(e)});if(!g.ok)throw await g.json()}catch(e){_apiExceptionHandler(e,"Adding Live Schedule to Event Failed")}}async function _createAndUpdateEvent(e,t,i,n,a,o,r,s,c,l,p,d,h,u,f,g,w,y,v,m,_,T,E,D,S,C,O,A,L,k){var U=new Headers;if(U.append("Content-Type","application/json"),U.append("Authorization","Bearer "+e),null===i){e=t+"/content/new?contentDefinitionId="+n;k&&console.log(`URL: ${e}
METHOD: GET`);try{var H=await fetch(e,{method:"GET",headers:U});if(!H.ok)throw await H.json();i=(await H.json()).contentId}catch(e){_apiExceptionHandler(e,"Get Content ID Failed")}}e=t+"/content/"+i,H={contentId:i,contentDefinitionId:n,properties:{contentRatings:null!==O?O:"",disabled:null!==A&&A,endDatetime:s,externalUrl:null!==g?g:"",featuredGroups:null!==E?E:[],genres:null!==v?v:[],groupSequence:null!==D?D:"",heroImage:null!==h?h:"",intelligentProgram:null!==f?f:"",languages:null!==_?_:[],liveChannel:null!==L?L:"",logoImage:null!==u?u:"",longDescription:null!==p?p:"",mediaAttributes:null!==m?m:[],name:a,performers:null!==y?y:[],primaryPerformer:null!==c?c:"",products:null!==T?T:[],recommendationSimilarItems:null!==C?C:[],relatedMediaItems:null!==S?S:[],routeName:_slugify(a),series:null!==o?o:"",shortDescription:null!==l?l:"",startDatetime:r,thumbnailImage:null!==d?d:"",venue:null!==w?w:""}};k&&console.log(`URL: ${e}
METHOD: PUT
BODY: `+JSON.stringify(H,null,4));try{var b=await fetch(e,{method:"PUT",headers:U,body:JSON.stringify(H)});if(b.ok)return await b.json();throw await b.json()}catch(e){_apiExceptionHandler(e,"Create and Update Event Instance Failed")}}async function _deleteEvent(e,t,i,n,a){t=t+`/content/${i}?contentDefinitionId=`+n,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var o=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Creating Form Failed")}}async function _getDefaultSiteConfig(e,t,i){var t=t+"/media/config",n=new Headers;n.append("Content-Type","application/json"),n.append("Authorization","Bearer "+e),i&&console.log(`URL: ${t}
