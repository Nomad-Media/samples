...
METHOD: POST`),await fetch(i.url,{method:"PUT",headers:r,body:o}));if(s.ok)return s.headers.get("ETag");throw await s.json()}catch(e){if(!(t<n-1)){_apiExceptionHandler(e,"Upload Part Failed");break}console.error(`Upload attempt ${t+1} failed. Retrying...`)}}async function _clearServerCache(e,t,i){var t=t+"/config/clearServerCache",a=new Headers;a.append("Content-Type","application/json"),a.append("Authorization","Bearer "+e),i&&console.log(`URL: ${t}
...
METHOD: GET`);try{var H=await fetch(e,{method:"GET",headers:I});if(!H.ok)throw await H.json();i=(await H.json()).contentId}catch(e){_apiExceptionHandler(e,"Get Content ID Failed")}}e=t+"/content/"+i,H={contentId:i,contentDefinitionId:a,properties:{contentRatings:null!==O?O:"",disabled:null!==A&&A,endDatetime:s,externalUrl:null!==g?g:"",featuredGroups:null!==D?D:[],genres:null!==m?m:[],groupSequence:null!==E?E:"",heroImage:null!==h?h:"",intelligentProgram:null!==f?f:"",languages:null!==_?_:[],liveChannel:null!==U?U:"",logoImage:null!==u?u:"",longDescription:null!==d?d:"",mediaAttributes:null!==v?v:[],name:n,performers:null!==w?w:[],primaryPerformer:null!==l?l:"",products:null!==T?T:[],recommendationSimilarItems:null!==C?C:[],relatedMediaItems:null!==S?S:[],routeName:_slugify(n),series:null!==o?o:"",shortDescription:null!==c?c:"",startDatetime:r,thumbnailImage:null!==p?p:"",venue:null!==y?y:""}};k&&console.log(`URL: ${e}
METHOD: PUT
