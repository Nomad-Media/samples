...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var l=await fetch(t,{method:"POST",headers:c,body:JSON.stringify(e)});if(l.ok)return await l.json();throw await l.json()}catch(e){_apiExceptionHandler(e,"Remove guest failed")}}async function _clearWatchlist(e,t,i,n){t=t+"/media/clear-watchlist?userId="+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
