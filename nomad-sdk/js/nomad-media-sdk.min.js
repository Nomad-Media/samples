...
METHOD: PUT
BODY: `+JSON.stringify(r));let w=null;try{var m=await fetch(f,{method:"PUT",headers:g,body:JSON.stringify(r)});if(!m.ok)throw await m.json();w=await m.json()}catch(e){_apiExceptionHandler(e,"Update Intelligent Playlist Failed")}const _=await _getScheduleItems(e,t,i,u);h=_[0],y=f+"/item/"+h.id,r={id:h.id,collections:0===a.length?h.collections:a,endSearchDate:n||h.endSearchDate,endSearchDurationInMinutes:o||h.endSearchDurationInMinutes,relatedContent:0===s?h.relatedContent:s,scheduleItemType:"2",searchDate:l||h.searchDate,searchDurationInMinutes:c||h.searchDurationInMinutes,searchFilterType:d||h.searchFilterType,sourceType:"2",tags:0===p.length?h.tags:p};u&&console.log(`URL: ${y}
METHOD: PUT
BODY: `+JSON.stringify(r));try{var v,T=await fetch(y,{method:"PUT",headers:g,body:JSON.stringify(r)});if(!T.ok)throw await T.json();const _=await T.json();for(v in w)_[v]=w[v];return _}catch(e){_apiExceptionHandler(e,"Update Intelligent Playlist Failed")}}async function _updateIntelligentSchedule(e,t,i,a,n,o,r,s){var l=t+"/admin/schedule/"+i,c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),await _getIntelligentSchedule(e,t,i,s)),t={defaultVideoAsset:a||e.defaultVideoAsset,id:i,name:n||e.name,scheduleType:3,thumbnailAsset:o||e.thumbnailAsset,timeZoneId:r||e.timeZoneId};s&&console.log(`URL: ${l}
METHOD: PUT
