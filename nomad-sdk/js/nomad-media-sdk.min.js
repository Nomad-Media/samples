...
METHOD: GET`);try{var H=await fetch(e,{method:"GET",headers:k});if(!H.ok)throw await H.json();i=(await H.json()).contentId}catch(e){_apiExceptionHandler(e,"Get Content ID Failed")}}e=t+"/content/"+i,H={contentId:i,contentDefinitionId:n,properties:{contentRatings:null!==C?C:"",disabled:null!==L&&L,endDatetime:s,externalUrl:null!==g?g:"",featuredGroups:null!==E?E:[],genres:null!==v?v:[],groupSequence:null!==D?D:"",heroImage:null!==h?h:"",intelligentProgram:null!==f?f:"",languages:null!==_?_:[],liveChannel:null!==A?A:"",logoImage:null!==u?u:"",longDescription:null!==p?p:"",mediaAttributes:null!==m?m:[],name:a,performers:null!==y?y:[],primaryPerformer:null!==l?l:"",products:null!==T?T:[],recommendationSimilarItems:null!==O?O:[],relatedMediaItems:null!==S?S:[],routeName:_slugify(a),series:null!==o?o:"",shortDescription:null!==c?c:"",startDatetime:r,thumbnailImage:null!==d?d:"",venue:null!==w?w:""}};U&&console.log(`URL: ${e}
METHOD: PUT
...
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:i});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Media Search Failed")}}async function _mediaSearch(e,t,i,n,a,o,r,s){var t=t+"/media/search",l=new Headers,e=(l.append("Content-Type","application/json"),l.append("Authorization","Bearer "+e),{searchQuery:i,ids:n,sortFields:a});e.pageOffset=o||0,e.pageSize=r||100,s&&console.log(`URL: ${t}
METHOD: POST
