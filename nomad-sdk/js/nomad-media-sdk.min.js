...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var y=await fetch(t,{method:"POST",headers:f,body:JSON.stringify(e)});if(!y.ok)throw await y.json()}catch(e){_apiExceptionHandler(e,"Adding Live Schedule to Event Failed")}}async function _createAndUpdateEvent(e,t,i,a,n,o,r,s,l,c,d,p,h,u,f,y,w,g,m,_,v,T,D,E,A,S,O,k,C,U){var H=new Headers;if(H.append("Content-Type","application/json"),H.append("Authorization","Bearer "+e),null===i){e=t+"/content/new?contentDefinitionId="+a;U&&console.log(`URL: ${e}
METHOD: GET`);try{var b=await fetch(e,{method:"GET",headers:H});if(!b.ok)throw await b.json();i=(await b.json()).contentId}catch(e){_apiExceptionHandler(e,"Get Content ID Failed")}}e=t+"/content/"+i,b={contentId:i,contentDefinitionId:a,properties:{contentRatings:null!==O?O:"",disabled:null!==k&&k,endDatetime:s,externalUrl:null!==y?y:"",featuredGroups:null!==D?D:[],genres:null!==m?m:[],groupSequence:null!==E?E:"",heroImage:null!==h?h:"",intelligentProgram:null!==f?f:"",languages:null!==v?v:[],liveChannel:null!==C?C:"",logoImage:null!==u?u:"",longDescription:null!==d?d:"",mediaAttributes:null!==_?_:[],name:n,performers:null!==g?g:[],primaryPerformer:null!==l?l:"",products:null!==T?T:[],recommendationSimilarItems:null!==S?S:[],relatedMediaItems:null!==A?A:[],routeName:_slugify(n),series:null!==o?o:"",shortDescription:null!==c?c:"",startDatetime:r,thumbnailImage:null!==p?p:"",venue:null!==w?w:""}};U&&console.log(`URL: ${e}
METHOD: PUT
BODY: `+JSON.stringify(b,null,4));try{var P=await fetch(e,{method:"PUT",headers:H,body:JSON.stringify(b)});if(P.ok)return await P.json();throw await P.json()}catch(e){_apiExceptionHandler(e,"Create and Update Event Instance Failed")}}async function _deleteEvent(e,t,i,a,n){t=t+`/content/${i}?contentDefinitionId=`+a,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
...
METHOD: POST`);try{var n=await fetch(t,{method:"POST",headers:i});if(!n.ok)throw await n.json()}catch(e){_apiExceptionHandler(e,"Stop Live Schedule Failed")}}async function _createLiveChannel(e,t,i,a,n,o,r,s,l,c,d,p,h,u){var f=t+"/liveChannel",y=new Headers,i=(y.append("Content-Type","application/json"),y.append("Authorization","Bearer "+e),{name:i,routeName:_slugify(i),enableHighAvailability:o,enableLiveClipping:r,externalOutputProfiles:p,isSecureOutput:s,outputScreenshots:l,type:{id:_LIVE_CHANNEL_TYPES[c],descrption:c}});a&&(i.thumbnailImage={id:a}),n&&(i.archiveFolderAsset={id:n}),"External"===c&&(i.externalUrl=d),h&&(o=await _getSecurityGroups(e,t,u),i.securityGroups=o.filter(e=>h.includes(e.description)).map(e=>({description:e.description,id:e.id}))),u&&console.log(`URL: ${f}
METHOD: POST
BODY: `+JSON.stringify(i,null,4));try{var w,g=await fetch(f,{method:"POST",headers:y,body:JSON.stringify(i)});if(g.ok)return await _waitForLiveChannelStatus(e,t,(w=await g.json()).id,_LIVE_CHANNEL_STATUSES.Idle,120,2,u),w;throw await g.json()}catch(e){_apiExceptionHandler(e,"Create Live Channel Failed")}}async function _deleteLiveChannel(t,e,i,a,n){e=e+"/liveChannel/"+i;let o=null;o=!0===a?(n&&console.log("Getting Live Channel Inputs IDs..."),await _getLiveChannelInputsIds(t,i)):null;i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+t),n&&console.log(`URL: ${e}
...
METHOD: POST
BODY: `+JSON.stringify(o));let y=null;try{var w=await fetch(u,{method:"POST",headers:f,body:JSON.stringify(o)});if(!w.ok)throw await w.json();y=await w.json()}catch(e){_apiExceptionHandler(e,"Create Intelligent Playlist Failed")}p=u+`/${y.id}/item`,o={collections:e,endSearchDate:a,endSearchDurationInMinutes:n,relatedContent:r,scheduleItemType:"2",searchDate:s,searchDurationInMinutes:l,searchFilterType:c,sourceType:"2",tags:d};h&&console.log(`URL: ${p}
METHOD: POST
BODY: `+JSON.stringify(o));try{var g=await fetch(p,{method:"POST",headers:f,body:JSON.stringify(o)});if(!g.ok)throw await g.json();var m,_=await g.json();for(m in y)_[m]=y[m];return _}catch(e){await _deleteIntelligentSchedule(t,i,y.id,h),_apiExceptionHandler(e,"Create Intelligent Playlist Failed")}}async function _createIntelligentSchedule(e,t,i,a,n,o,r){var t=t+"/admin/schedule",s=new Headers,e=(s.append("Content-Type","application/json"),s.append("Authorization","Bearer "+e),{defaultVideoAsset:i,name:a,scheduleType:3,thumbnailAsset:n,timeZoneId:o});r&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: POST
BODY: `+JSON.stringify(e));try{var d=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(d.ok)return await d.json();throw await d.json()}catch(e){_apiExceptionHandler(e,"Create Schedule Item Failed")}}async function _createScheduleItemSearchFilter(e,t,i,a,n,o,r,s,l,c,d,p,h,u,f,y,w){t+=`/admin/schedule/${i}/item`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={collections:a,days:n,durationTimeCode:o,endSearchDate:r,endSearchDuratonInMinutes:s,endTimeCode:l,previousItem:c,relatedContent:d,scheduleItemType:"1",searchDate:p,searchDurationInMinutes:h,searchFilterType:u,sourceType:"2",tags:f,timeCode:y};w&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var g=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(g.ok)return await g.json();throw await g.json()}catch(e){_apiExceptionHandler(e,"Create Schedule Item Failed")}}async function _createScheduleItemPlaylistSchedule(e,t,i,a,n,o,r,s,l,c){t+=`/admin/schedule/${i}/item`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={days:a,durationTimeCode:n,endTimeCode:o,playlistSchedule:r,previousItem:s,scheduleItemType:"2",sourceType:"1",timeCode:l};c&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: POST`);try{var o=await fetch(t,{method:"POST",headers:i});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Stop Schedule Failed")}}async function _updateIntelligentPlaylist(e,t,i,a,n,o,r,s,l,c,d,p,h,u){var f=t+"/admin/schedule/"+i,y=new Headers,w=(y.append("Content-Type","application/json"),y.append("Authorization","Bearer "+e),await _getIntelligentPlaylist(e,t,i,u)),r={name:r||w.name,scheduleType:"4",thumbnailAsset:h||w.thumbnailAsset,scheduleStatus:w.scheduleStatus,status:w.status};u&&console.log(`URL: ${f}
METHOD: PUT
BODY: `+JSON.stringify(r));let g=null;try{var m=await fetch(f,{method:"PUT",headers:y,body:JSON.stringify(r)});if(!m.ok)throw await m.json();g=await m.json()}catch(e){_apiExceptionHandler(e,"Update Intelligent Playlist Failed")}const _=await _getScheduleItems(e,t,i,u);h=_[0],w=f+"/item/"+h.id,r={id:h.id,collections:0===a.length?h.collections:a,endSearchDate:n||h.endSearchDate,endSearchDurationInMinutes:o||h.endSearchDurationInMinutes,relatedContent:0===s?h.relatedContent:s,scheduleItemType:"2",searchDate:l||h.searchDate,searchDurationInMinutes:c||h.searchDurationInMinutes,searchFilterType:d||h.searchFilterType,sourceType:"2",tags:0===p.length?h.tags:p};u&&console.log(`URL: ${w}
METHOD: PUT
BODY: `+JSON.stringify(r));try{var v,T=await fetch(w,{method:"PUT",headers:y,body:JSON.stringify(r)});if(!T.ok)throw await T.json();const _=await T.json();for(v in g)_[v]=g[v];return _}catch(e){_apiExceptionHandler(e,"Update Intelligent Playlist Failed")}}async function _updateIntelligentSchedule(e,t,i,a,n,o,r,s){var l=t+"/admin/schedule/"+i,c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),await _getIntelligentSchedule(e,t,i,s)),t={defaultVideoAsset:a||e.defaultVideoAsset,id:i,name:n||e.name,scheduleType:3,thumbnailAsset:o||e.thumbnailAsset,timeZoneId:r||e.timeZoneId};s&&console.log(`URL: ${l}
METHOD: PUT
...
METHOD: PUT
BODY: `+JSON.stringify(t));try{var h=await fetch(d,{method:"PUT",headers:p,body:JSON.stringify(t)});if(h.ok)return await h.json();throw await h.json()}catch(e){_apiExceptionHandler(e,"Update Schedule Item Failed")}}async function _updateScheduleItemSearchFilter(e,t,i,a,n,o,r,s,l,c,d,p,h,u,f,y,w){var g=t+`/admin/schedule/${i}/item/`+a,m=new Headers,e=(m.append("Content-Type","application/json"),m.append("Authorization","Bearer "+e),await _getScheduleItem(e,t,i,a,w)),t={collections:n||e.collections,days:o||e.days,durationTimeCode:r||e.durationTimeCode,endSearchDate:s||e.endSearchDate,endSearchDuratonInMinutes:l||e.endSearchDuratonInMinutes,endTimeCode:c||e.endTimeCode,id:a,relatedContent:d||e.relatedContent,scheduleItemType:"1",searchDate:p||e.searchDate,searchDurationInMinutes:h||e.searchDurationInMinutes,searchFilterType:u||e.searchFilterType,sourceType:"2",tags:f||e.tags,timeCode:y||e.timeCode};w&&console.log(`URL: ${g}
METHOD: PUT
BODY: `+JSON.stringify(t));try{var _=await fetch(g,{method:"PUT",headers:m,body:JSON.stringify(t)});if(_.ok)return await _.json();throw await _.json()}catch(e){_apiExceptionHandler(e,"Update Schedule Item Failed")}}async function _changeSessionStatus(e,t,i,a,n,o){var t=t+"/admin/user-session",r=new Headers,e=(r.append("Content-Type","application/json"),r.append("Authorization","Bearer "+e),{id:i,userSessionStatus:a,applicationId:n});o&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: DELETE`);try{var n=await fetch(t,{method:"DELETE",headers:i});if(!n.ok)throw await n.json()}catch(e){_apiExceptionHandler(e,"Delete User Session Data Failed")}}async function _deleteUserVideoTrackingData(e,t,i,a,n,o,r,s,l,c,d,p,h,u,f,y,w,g,m){var t=t+"/admin/user/userVideoTracking/delete",_=new Headers,e=(_.append("Content-Type","application/json"),_.append("Authorization","Bearer "+e),{assetId:i,contentId:a,videoTrackingAttribute:n,userId:o,id:r,isFirstQuartile:s,isMidpoint:l,isThirdQuartile:c,isComplete:d,isHidden:p,isLiveStream:h,maxSecond:u,lastSecond:f,totalSeconds:y,lastBeaconDate:w,keyName:g});m&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var v=await fetch(t,{method:"POST",headers:_,body:JSON.stringify(e)});if(!v.ok)throw await v.json()}catch(e){_apiExceptionHandler(e,"Delete User Video Tracking Data Failed")}}async function _deleteUser(e,t,i,a){t=t+"/admin/user/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var n=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Login Failed")}}async function _logout(e,t,i){var t=t+"/account/logout",a=new Headers;a.append("Content-Type","application/json"),a.append("Authorization","Bearer "+e),i&&console.log(`URL: ${t}
METHOD: POST`);try{var n=await fetch(t,{method:"POST",headers:a});if(!n.ok)throw await n.json()}catch(e){_apiExceptionHandler(e,"Logout Failed")}}async function _refreshToken(e,t,i){var t=t+"/account/refresh-token",a=new Headers,e=(a.append("Content-Type","application/json"),{refreshToken:e});i&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: POST
BODY: `+JSON.stringify(t,null,4));try{var r=await fetch(e,{method:"POST",headers:o,body:JSON.stringify(t)});if(!r.ok)throw await r.json()}catch(e){_apiExceptionHandler(e,"Reset Password Failed")}}async function _archiveAsset(e,t,i,a){t+=`/admin/asset/${i}/archive`,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: POST`);try{var n=await fetch(t,{method:"POST",headers:i});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Archive Asset Failed")}}async function _batchAction(e,t,i,a,n,o,r,s,l,c,d){t=t+"/admin/asset/"+i,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={batchAction:a,contentDefinitionId:n,schemaName:o,targetIds:r,userId:s,actionArguments:l,resolverExempt:c};d&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var p=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(p.ok)return await p.json();throw await p.json()}catch(e){_apiExceptionHandler(e,"Batch Action Failed")}}async function _buildMedia(e,t,i,a,n,o,r,s,l,c,d){var t=t+"/asset/build-media",p=new Headers,e=(p.append("Content-Type","application/json"),p.append("Authorization","Bearer "+e),{sources:i,title:a,tags:n,collections:o,relatedContent:r,destinationFolderId:s,videoBitrate:l,audioTracks:c});d&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var h=await fetch(t,{method:"POST",headers:p,body:JSON.stringify(e)});if(h.ok)return await h.json();throw await h.json()}catch(e){_apiExceptionHandler(e,"Build Media Failed")}}async function _clipAsset(e,t,i,a,n,o,r,s,l,c,d,p,h,u){a="admin"===a?t+`/admin/asset/${i}/clip`:t+`/asset/${i}/clip`,t=new Headers,t.append("Content-Type","application/json"),t.append("Authorization","Bearer "+e),i={startTimeCode:n,endTimeCode:o,title:r,output_folder_id:s,tags:l,collections:c,relatedContent:d,videoBitrate:p,audioTracks:h};u&&console.log(`URL: ${a}
METHOD: POST
BODY: `+JSON.stringify(i));try{var f=await fetch(a,{method:"POST",headers:t,body:JSON.stringify(i)});if(f.ok)return await f.json();throw await f.json()}catch(e){_apiExceptionHandler(e,"Clip Asset Failed")}}async function _copyAsset(e,t,i,a,n,o,r,s,l,c,d){t+=`/admin/asset/${i}/copy`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={batchAction:a,contentDefinitionId:n,schemaName:o,targetIds:r,userId:s,actionArguments:l,resolverExempt:c};d&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var p=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(p.ok)return await p.json();throw await p.json()}catch(e){_apiExceptionHandler(e,"Copy Asset Failed")}}async function _createAnnotation(e,t,i,a,n,o,r,s,l){var t=t+`/asset/${i}/annotation`,c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),l&&console.log(`URL: ${t}
METHOD: POST`),{id:i,startTimeCode:a,endTimeCode:n,properties:o,contentId:r,imageUrl:s});try{var d=await fetch(t,{method:"POST",headers:c,body:JSON.stringify(e)});if(d.ok)return await d.json();throw await d.json()}catch(e){_apiExceptionHandler(e,"Create Annotation Failed")}}async function _createAssetAdBreak(e,t,i,a,n,o,r){var t=t+`/admin/asset/${i}/adbreak`,s=new Headers,e=(s.append("Content-Type","application/json"),s.append("Authorization","Bearer "+e),{id:i,timeCode:a,tags:n,labels:o});r&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var l=await fetch(t,{method:"POST",headers:s,body:JSON.stringify(e)});if(l.ok)return await l.json();throw await l.json()}catch(e){_apiExceptionHandler(e,"Create Asset Ad Break Failed")}}async function _createFolderAsset(e,t,i,a,n){t+=`/admin/asset/${i}/create-folder`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={displayName:a};n&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var o=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Create Folder Asset Failed")}}async function _createPlaceholderAsset(e,t,i,a,n){t+=`/admin/asset/${i}/create-placeholder`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={assetName:a};n&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var o=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Create Placeholder Asset Failed")}}async function _createScreenshotAtTimecode(e,t,i,a,n){t+=`/admin/asset/${i}/screenshot`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={timecode:a};n&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var o=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Create Screenshot At Timecode Failed")}}async function _deleteAnnotation(e,t,i,a,n){t=t+`/asset/${i}/annotation/`+a,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var o=await fetch(t,{method:"DELETE",headers:i});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Delete Annotation Failed")}}async function _deleteAssetAdBreak(e,t,i,a,n){t=t+`/admin/asset/${i}/adbreak/`+a,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var o=await fetch(t,{method:"DELETE",headers:i});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Delete Ad Break Failed")}}async function _deleteAsset(e,t,i,a){t=t+"/admin/asset/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: DELETE`);try{var n=await fetch(t,{method:"DELETE",headers:i});if(!n.ok)throw await n.json()}catch(e){_apiExceptionHandler(e,"Delete Asset Failed")}}async function _downloadArchiveAsset(e,t,i,a,n,o,r){var t="admin"===i?t+"/admin/asset/download-archive":t+"/asset/download-archive",s=new Headers,e=(s.append("Content-Type","application/json"),s.append("Authorization","Bearer "+e),{assetIds:a});"admin"===i&&(e.fileName=n),"admin"===i&&(e.downloadProxy=o),r&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var l=await fetch(t,{method:"POST",headers:s,body:JSON.stringify(e)});if(l.ok)return await l.json();throw await l.json()}catch(e){_apiExceptionHandler(e,"Asset Download Archive Failed")}}async function _duplicateAsset(e,t,i,a){t+=`/admin/asset/${i}/duplicate`,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: POST`);try{var n=await fetch(t,{method:"POST",headers:i});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Duplicate Asset Failed")}}async function _getAnnotations(e,t,i,a){t+=`/asset/${i}/annotation`,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:i});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Get Annotations Failed")}}async function _getAssetAdBreaks(e,t,i,a){t+=`/admin/asset/${i}/adbreak`,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:i});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Get Asset Ad Break Failed")}}async function _getAssetChildNodes(e,t,i,a,n,o,r,s,l){t=new URL(t+`/asset/admin/asset/${i}/getAssetChildNodes`),i=new URLSearchParams,i.append("folderId",a),i.append("sortColumn",n),i.append("isDesc",o),i.append("pageIndex",r),i.append("pageSize",s),t.search=i.toString(),a=new Headers;a.append("Content-Type","application/json"),a.append("Authorization","Bearer "+e),l&&console.log(`URL: ${t}
METHOD: GET`);try{var c=await fetch(t,{method:"GET",headers:a});if(c.ok)return await c.json();throw await c.json()}catch(e){_apiExceptionHandler(e,"Get Asset Child Node Failed")}}async function _getAssetDetails(e,t,i,a,n){a="admin"===a?t+`/admin/asset/${i}/detail`:t+`/asset/${i}/detail`,t=new Headers;t.append("Content-Type","application/json"),t.append("Authorization","Bearer "+e),n&&console.log(`URL: ${a}
METHOD: GET`);try{var o=await fetch(a,{method:"GET",headers:t});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Get Asset Details Failed")}}async function _getAssetManifestWithCookies(e,t,i,a,n,o){n="admin"===n?t+`/admin/asset/${i}/set-cookies/`+a:t+`/asset/${i}/set-cookies/`+a,t=new Headers;t.append("Content-Type","application/json"),t.append("Authorization","Bearer "+e),o&&console.log(`URL: ${n}
METHOD: GET`);try{var r=await fetch(n,{method:"GET",headers:t});if(r.ok)return await r.json();throw await r.json()}catch(e){_apiExceptionHandler(e,"Get Asset Manifest Failed")}}async function _getAssetMetadataSummary(e,t,i,a){t+=`/admin/asset/${i}/metadata-summary`,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:i});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Get Asset Metadata Summary Failed")}}async function _getAssetParentFolders(e,t,i,a,n){t=t+`/admin/asset/${i}/parent-folders?pageSize=`+a,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: GET`);try{var o=await fetch(t,{method:"GET",headers:i});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Get Parent Folders Failed")}}async function _getAssetScreenshotDetails(e,t,i,a,n,o){t+=`/admin/asset/${i}/${a}/${n}/detail`,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),o&&console.log(`URL: ${t}
METHOD: GET`);try{var r=await fetch(t,{method:"GET",headers:i});if(r.ok)return await r.json();throw await r.json()}catch(e){_apiExceptionHandler(e,"Get Asset Screenshot Details Failed")}}async function _getAssetSegmentDetails(e,t,i,a,n){t+=`/admin/asset/${i}/${a}/detail`,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: GET`);try{var o=await fetch(t,{method:"GET",headers:i});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Get Asset Segment Details Failed")}}async function _getAsset(e,t,i,a){t=t+"/admin/asset/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:i});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Get Asset Failed")}}async function _getUserUploadParts(e,t,i,a){t=t+"/admin/asset/upload/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:i});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Get User Upload Parts Failed")}}async function _getUserUploads(e,t,i,a){t=t+"/admin/asset/upload?includeCompletedUploads="+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:i});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Get User Uploads Failed")}}async function _importAnnotations(e,t,i,a,n){t+=`/asset/${i}/annotation/import`,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(a));try{var o=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(a)});if(!o.ok)throw await o.json()}catch(e){_apiExceptionHandler(e,"Import Annotations Failed")}}async function _indexAsset(e,t,i,a){t+=`/admin/asset/${i}/index`,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: POST`);try{var n=await fetch(t,{method:"POST",headers:i});if(!n.ok)throw await n.json()}catch(e){_apiExceptionHandler(e,"Index Asset Failed")}}async function _localRestoreAsset(e,t,i,a,n){t+=`/asset/${i}/localRestore`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={profile:a};n&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var o=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Local Restore Asset Failed")}}async function _moveAsset(e,t,i,a,n,o,r,s,l,c,d){t+=`/admin/asset/${i}/move`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={batchAction:o,contentDefinitionId:r,schemaName:s,targetIds:n,userId:l,actionArguments:a,resolverExempt:c};d&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var p=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(!p.ok)throw await p.json()}catch(e){_apiExceptionHandler(e,"Move Asset Failed")}}async function _recordsAssetTrackingBeacon(e,t,i,a,n,o,r,s){var t=new URL`${t}/asset/tracking`,l=t.searchParams,a=(l.append("trackingEvent",a),l.append("assetId",i),l.append("liveChannelId",n),l.append("contentId",o),l.append("second",r),t.search=l.toString(),new Headers);a.append("Content-Type","application/json"),a.append("Authorization","Bearer "+e),s&&console.log(`URL: ${t}
METHOD: GET`);try{var c=await fetch(t,{method:"GET",headers:a});if(!c.ok)throw await c.json()}catch(e){_apiExceptionHandler(e,"Records Asset Tracking Beacon Failed")}}async function _registerAsset(e,t,i,a,n,o,r,s,l,c,d,p,h,u,f,y,w,g,m,_,v,T){var t=t+"/admin/asset/register",D=new Headers,e=(D.append("Content-Type","application/json"),D.append("Authorization","Bearer "+e),{id:i,parentId:a,displayObjectKey:n,bucketName:o,objectKey:r,eTag:s,tags:l,collections:c,relatedContent:d,sequencer:p,assetStatus:h,storageClass:u,assetType:f,contentLength:y,storageEventName:w,createdDate:g,storageSourceIpAddress:m,startMediaProcessor:_,deleteMissingAsset:v});T&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var E=await fetch(t,{method:"POST",headers:D,body:JSON.stringify(e)});if(!E.ok)throw await E.json()}catch(e){_apiExceptionHandler(e,"Register Asset Failed")}}async function _reprocessAsset(e,t,i,a){var t=t+"/admin/asset/reprocess",n=new Headers,e=(n.append("Content-Type","application/json"),n.append("Authorization","Bearer "+e),{targetIds:i});a&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var o=await fetch(t,{method:"POST",headers:n,body:JSON.stringify(e)});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Reprocess Asset Failed")}}async function _restoreAsset(e,t,i,a,n){a="admin"===a?t+`/admin/asset/${i}/restore`:t+`/asset/${i}/restore`,t=new Headers;t.append("Content-Type","application/json"),t.append("Authorization","Bearer "+e),n&&console.log(`URL: ${a}
METHOD: POST`);try{var o=await fetch(a,{method:"POST",headers:t});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Restore Asset Failed")}}async function _shareAsset(e,t,i,a,n,o,r){var t=t+`/asset/${i}/share`,s=new Headers,e=(s.append("Content-Type","application/json"),s.append("Authorization","Bearer "+e),r&&console.log(`URL: ${t}
METHOD: POST`),{assetId:i,nomadUsers:a,externalUsers:n,shareDurationInHours:o});r&&console.log("BODY: "+JSON.stringify(e));try{var l=await fetch(t,{method:"POST",headers:s,body:JSON.stringify(e)});if(l.ok)return await l.json();throw await l.json()}catch(e){_apiExceptionHandler(e,"Share Asset Failed")}}async function _startWorkflow(e,t,i,a,n){var t=t+"/admin/asset/startWorkflow",o=new Headers,e=(o.append("Content-Type","application/json"),o.append("Authorization","Bearer "+e),{actionArguments:i,targetIds:a});n&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var r=await fetch(t,{method:"POST",headers:o,body:JSON.stringify(e)});if(r.ok)return await r.json();throw await r.json()}catch(e){_apiExceptionHandler(e,"Start Workflow Failed")}}async function _transcribeAsset(e,t,i,a,n,o){t=t+`/admin/asset/${i}/transcript/`+a,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),o&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(n));try{var r=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(n)});if(r.ok)return await r.json();throw await r.json()}catch(e){_apiExceptionHandler(e,"Transcribe Asset Failed")}}async function _updateAnnotation(e,t,i,a,n,o,r,s,l,c){t=t+`/asset/${i}/annotation/`+a,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={id:a,startTimeCode:n,endTimeCode:o,properties:r,contentId:s,imageUrl:l};c&&console.log(`URL: ${t}
METHOD: PUT
BODY: `+JSON.stringify(e));try{var d=await fetch(t,{method:"PUT",headers:i,body:JSON.stringify(e)});if(d.ok)return await d.json();throw await d.json()}catch(e){_apiExceptionHandler(e,"Update Annotations Failed")}}async function _updateAssetAdBreak(e,t,i,a,n,o,r,s){t=t+`/admin/asset/${i}/adbreak/`+a,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={id:a,timeCode:n,tags:o,labels:r};s&&console.log(`URL: ${t}
METHOD: PUT
BODY: `+JSON.stringify(e));try{var l=await fetch(t,{method:"PUT",headers:i,body:JSON.stringify(e)});if(l.ok)return await l.json();throw await l.json()}catch(e){_apiExceptionHandler(e,"Update Asset Ad Break Failed")}}async function _updateAssetLanguage(e,t,i,a,n){t+=`/admin/asset/${i}/language`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: POST`),e={languageId:a};n&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var o=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(!o.ok)throw await o.json()}catch(e){_apiExceptionHandler(e,"Update Asset Language Failed")}}async function _updateAsset(e,t,i,a,n,o,r,s,l){t=t+"/admin/asset/"+i,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={displayName:a,displayDate:n,availableStartDate:o,availableEndDate:r,customProperties:s};l&&console.log(`URL: ${t}
METHOD: PATCH
BODY: `+JSON.stringify(e));try{var c=await fetch(t,{method:"PATCH",headers:i,body:JSON.stringify(e)});if(!c.ok)throw await c.json()}catch(e){_apiExceptionHandler(e,"Update Asset Failed")}}async function _ping(e,t,i,a,n){var t=t+"/account/ping",o=new Headers,e=(o.append("Content-Type","application/json"),o.append("Authorization","Bearer "+e),{userId:a});i&&(e.applicationId=i),n&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:a});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Get user failed")}}async function _updateUser(e,t,i,a,n,o,r,s,l,c,d,p,h,u){var f,y=await _getUser(e,t,u),w=t+"/account/user",g=new Headers,m=(g.append("Content-Type","application/json"),g.append("Authorization","Bearer "+e),{}),_=(await _getCountries(e,t,u)).find(e=>e.label===o),v={address:i,address2:a,city:n,state:(await _getStates(e,t,u)).find(e=>e.label===h).label,country:_,firstName:r,lastName:s,phone:c,phoneExt:d,postalCode:p,organization:l};for(const D in v)null!==v[D]?m[D]=v[D]:null!=(f=y[D])&&(m[D]=f);u&&console.log(`URL: ${w}
METHOD: PUT
BODY: `+JSON.stringify(m,null,4));try{var T=await fetch(w,{method:"PUT",headers:g,body:JSON.stringify(m)});return T.ok||await T.json(),await T.json()}catch(e){_apiExceptionHandler(e,"Update user failed")}}async function _addContentsToContentGroup(e,t,i,a,n){t=t+"/contentgroup/add/"+i,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e=a;n&&console.log(`URL: ${t}
METHOD: POST
