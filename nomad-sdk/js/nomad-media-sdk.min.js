...
METHOD: POST`),await fetch(i.url,{method:"PUT",headers:r,body:o}));if(s.ok)return s.headers.get("ETag");throw await s.json()}catch(e){if(!(t<n-1)){_apiExceptionHandler(e,"Upload Part Failed");break}console.error(`Upload attempt ${t+1} failed. Retrying...`)}}async function _addCustomProperties(e,t,i,a,n,o,r){t=t+"/admin/asset/"+i,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={displayName:a,displayDate:n,customProperties:o};r&&console.log(`URL: ${t}
METHOD: PATCH
...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var g=await fetch(t,{method:"POST",headers:f,body:JSON.stringify(e)});if(!g.ok)throw await g.json()}catch(e){_apiExceptionHandler(e,"Adding Live Schedule to Event Failed")}}async function _createAndUpdateEvent(e,t,i,a,n,o,r,s,l,c,d,p,h,u,f,g,y,w,m,_,v,T,D,E,S,C,O,A,U,k){var I=new Headers;if(I.append("Content-Type","application/json"),I.append("Authorization","Bearer "+e),null===i){e=t+"/content/new?contentDefinitionId="+a;k&&console.log(`URL: ${e}
METHOD: GET`);try{var L=await fetch(e,{method:"GET",headers:I});if(!L.ok)throw await L.json();i=(await L.json()).contentId}catch(e){_apiExceptionHandler(e,"Get Content ID Failed")}}e=t+"/content/"+i,L={contentId:i,contentDefinitionId:a,properties:{contentRatings:null!==O?O:"",disabled:null!==A&&A,endDatetime:s,externalUrl:null!==g?g:"",featuredGroups:null!==D?D:[],genres:null!==m?m:[],groupSequence:null!==E?E:"",heroImage:null!==h?h:"",intelligentProgram:null!==f?f:"",languages:null!==v?v:[],liveChannel:null!==U?U:"",logoImage:null!==u?u:"",longDescription:null!==d?d:"",mediaAttributes:null!==_?_:[],name:n,performers:null!==w?w:[],primaryPerformer:null!==l?l:"",products:null!==T?T:[],recommendationSimilarItems:null!==C?C:[],relatedMediaItems:null!==S?S:[],routeName:_slugify(n),series:null!==o?o:"",shortDescription:null!==c?c:"",startDatetime:r,thumbnailImage:null!==p?p:"",venue:null!==y?y:""}};k&&console.log(`URL: ${e}
METHOD: PUT
BODY: `+JSON.stringify(L,null,4));try{var H=await fetch(e,{method:"PUT",headers:I,body:JSON.stringify(L)});if(H.ok)return await H.json();throw await H.json()}catch(e){_apiExceptionHandler(e,"Create and Update Event Instance Failed")}}async function _deleteEvent(e,t,i,a,n){t=t+`/content/${i}?contentDefinitionId=`+a,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
...
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:i});if(!n.ok)throw await n.json();try{return await n.json()}catch(e){return!1}}catch(e){_apiExceptionHandler(e,"Get Live Schedule Failed")}}const Lookup=(e,t)=>({key:e,value:t}),DAY_OF_WEEK={Sunday:Lookup("7","3fc3b5ec-88be-41c9-be8f-5199735f3603"),Monday:Lookup("1","16bebfa8-65cc-451e-9744-d09d6c761e4a"),Tuesday:Lookup("2","02782764-f644-43fa-89cb-40cd3a3c3ece"),Wednesday:Lookup("3","1ca7cf91-5460-479f-84e5-e02cd51ca3f9"),Thursday:Lookup("4","2691d391-e1b1-43b6-97e2-5fc6b39479ef"),Friday:Lookup("5","b1897795-37a3-4a6e-a702-93643fe2ecab"),Saturday:Lookup("6","cf4c7688-417f-48d4-8b9d-fc6e6132d34e")};function _processDates(t,i){var a=[];for(let e=0;e<t.length;++e){const o=t[e];var n={description:o,id:DAY_OF_WEEK[o].value,properties:{abbreviation:o.substr(0,3),name:o,sortOrder:DAY_OF_WEEK[o].key}};a.push(n)}const o=new Date;let r=1,s=DAY_OF_WEEK[t[0]].key-o.getDay();for(;s<0;){var e=DAY_OF_WEEK[t[r]].key-o.getDay();(0<e||1<=(new Date(i).getTime()-o.getTime())/36e5)&&(s=e),++r}for(let e=r;e<t.length;++e){var l=DAY_OF_WEEK[t[e]].key-o.getDay();l<s&&((new Date(i).getTime()-o.getTime())/36e5<1||(s=l))}return o.setDate(o.getDate()+s),a}async function _startLiveSchedule(e,t,i,a){t+=`/admin/liveSchedule/content/${i}/start`,i=new Headers;i.append("Authorization","Bearer "+e),i.append("Content-Type","application/json"),a&&console.log(`URL: ${t}
...
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:a});if(n.ok)return(await n.json()).items;throw await n.json()}catch(e){_apiExceptionHandler(e,"Get Security Groups Failed")}}const _SECURITY_GROUPS={"Content Manager":"e81e25ba-b6ab-4676-980c-f51385008eb3",Everyone:"740ea96a-9c15-4c2e-ba1a-050ea893514b",Guest:"8354ce06-deeb-4da9-a190-af0eca8d9f56"},_LIVE_CHANNEL_STATUSES={CreateFailed:"Create Failed",Creating:"Creating",Deleted:"Deleted",Deleting:"Deleting",Error:"Error",Idle:"Idle",New:"New",Pause:"Pause",Recovering:"Recovering",Running:"Running",Starting:"Starting",Stopping:"Stopping",Unmanaged:"Unmanaged",UpdateFailed:"Update Failed",Updating:"Updating"},_LIVE_CHANNEL_TYPES={External:"2bf01dd4-0a9c-4168-a61b-27e135732103",IVS:"2bf01dd4-0a9c-4168-a61b-27e135732102",Normal:"2bf01dd4-0a9c-4168-a61b-27e135732100",Realtime:"2bf01dd4-0a9c-4168-a61b-27e135732104"};async function _startLiveChannel(e,t,i,a){var n=t+`/liveChannel/${i}/start`,o=new Headers;o.append("Content-Type","application/json"),o.append("Authorization","Bearer "+e),a&&console.log(`URL: ${n}
METHOD: POST`);try{var r=await fetch(n,{method:"POST",headers:o});if(!r.ok)throw await r.json();await _waitForLiveChannelStatus(e,t,i,_LIVE_CHANNEL_STATUSES.Running,1200,20)}catch(e){_apiExceptionHandler(e,"Start Live Channel Failed")}}async function _stopLiveChannel(e,t,i,a){var n=t+`/liveChannel/${i}/stop`,o=new Headers;o.append("Authorization","Bearer "+e),a&&console.log(`URL: ${n}
...
METHOD: POST
BODY: `+JSON.stringify(o));let g=null;try{var y=await fetch(u,{method:"POST",headers:f,body:JSON.stringify(o)});if(!y.ok)throw await y.json();g=await y.json()}catch(e){await _deleteIntelligentSchedule(t,i,g.id,h),_apiExceptionHandler(e,"Create Intelligent Playlist Failed")}p=u+`/${g.id}/item`,o={collections:e,endSearchDate:a,endSearchDurationInMinutes:n,relatedContent:r,scheduleItemType:"2",searchDate:s,searchDurationInMinutes:l,searchFilterType:c,sourceType:"2",tags:d};h&&console.log(`URL: ${p}
METHOD: POST
BODY: `+JSON.stringify(o));try{var w=await fetch(p,{method:"POST",headers:f,body:JSON.stringify(o)});if(!w.ok)throw await w.json();var m,_=await w.json();for(m in g)_[m]=g[m];return _}catch(e){_apiExceptionHandler(e,"Create Intelligent Playlist Failed")}}async function _createIntelligentSchedule(e,t,i,a,n,o,r){var t=t+"/admin/schedule",s=new Headers,e=(s.append("Content-Type","application/json"),s.append("Authorization","Bearer "+e),{defaultVideoAsset:i,name:a,scheduleType:3,thumbnailAsset:n,timeZoneId:o});r&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var l=await fetch(t,{method:"POST",headers:s,body:JSON.stringify(e)});if(l.ok)return await l.json();throw await l.json()}catch(e){_apiExceptionHandler(e,"Create Intelligent Schedule Failed")}}async function _createPlaylist(e,t,i,a,n,o,r){var t=t+"/admin/schedule",s=new Headers,e=(s.append("Content-Type","application/json"),s.append("Authorization","Bearer "+e),{defaultVideoAsset:i,loopPlaylist:a,name:n,scheduleType:"1",thumbnailAsset:o});r&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:i});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Get Schedule Preview Failed")}}async function _moveScheduleItem(e,t,i,a,n,o){t+=`/admin/schedule/${i}/item/${a}/move`,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a={previousItem:n};o&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(a));try{var r=await fetch(t,{method:"POST",headers:i});if(r.ok)return await r.json();throw await r.json()}catch(e){_apiExceptionHandler(e,"Move Schedule Items Failed")}}async function _publishIntelligentSchedule(e,t,i,a,n){var t=t+`/admin/schedule/${i}/publish`,o=new Headers,e=(o.append("Content-Type","application/json"),o.append("Authorization","Bearer "+e),{scheduleId:i,numberOfLockedDays:a});n&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var r=await fetch(t,{method:"POST",headers:o,body:JSON.stringify(e)});if(r.ok)return await r.json();throw await r.json()}catch(e){_apiExceptionHandler(e,"Publish Schedule Failed")}}async function _startSchedule(e,t,i,a,n){t=t+`/admin/schedule/${i}/start`+(null!==a?"?skipCleanupOnFailure="+a:""),i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
...
METHOD: POST`);try{var o=await fetch(t,{method:"POST",headers:i});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Stop Schedule Failed")}}async function _updateIntelligentPlaylist(e,t,i,a,n,o,r,s,l,c,d,p,h,u){var f=t+"/admin/schedule/"+i,g=new Headers,i=(g.append("Content-Type","application/json"),g.append("Authorization","Bearer "+e),await _getIntelligentSchedule(e,t,i,u)),r={name:r||i.name,scheduleType:"4",thumbnailAsset:h||i.thumbnailAsset};u&&console.log(`URL: ${f}
METHOD: PUT
BODY: `+JSON.stringify(r));let y=null;try{var w=await fetch(f,{method:"PUT",headers:g,body:JSON.stringify(r)});if(!w.ok)throw await w.json();y=await w.json()}catch(e){_apiExceptionHandler(e,"Create Intelligent Playlist Failed")}h=f+`/${y}/item`;const m=await _getIntelligentSchedule(e,t,y.id,u);i={collections:a||m.collections,endSearchDate:n||m.endSearchDate,endSearchDurationInMinutes:o||m.endSearchDurationInMinutes,relatedContent:s||m.relatedContent,scheduleItemType:"2",searchDate:l||m.searchDate,searchDurationInMinutes:c||m.searchDurationInMinutes,searchFilterType:d||m.searchFilterType,sourceType:"2",tags:p||m.tags};u&&console.log(`URL: ${h}
METHOD: PUT
BODY: `+JSON.stringify(i));try{var _,v=await fetch(h,{method:"PUT",headers:g,body:JSON.stringify(i)});if(!v.ok)throw await v.json();const m=await v.json();for(_ in y)m[_]=y[_];return m}catch(e){_apiExceptionHandler(e,"Create Intelligent Playlist Failed")}}async function _updateIntelligentSchedule(e,t,i,a,n,o,r,s){var l=t+"/admin/schedule/"+i,c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),await _getIntelligentSchedule(e,t,i,s)),t={defaultVideoAsset:a||e.defaultVideoAsset,id:i,name:n||e.name,scheduleType:3,thumbnailAsset:o||e.thumbnailAsset,timeZoneId:r||e.timeZoneId};s&&console.log(`URL: ${l}
METHOD: PUT
BODY: `+JSON.stringify(t));try{var d=await fetch(l,{method:"PUT",headers:c,body:JSON.stringify(t)});if(d.ok)return await d.json();throw await d.json()}catch(e){_apiExceptionHandler(e,"Update Intelligent Schedule Failed")}}async function _updatePlaylist(e,t,i,a,n,o,r,s){var l=t+"/admin/schedule/"+i,c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),await _getPlaylist(e,t,i,s)),t={defaultVideoAsset:a||e.defaultVideoAsset,id:i,loopPlaylist:n||e.loopPlaylist,name:o||e.name,scheduleType:"1",thumbnailAsset:r||e.thumbnailAsset};s&&console.log(`URL: ${l}
METHOD: POST
BODY: `+JSON.stringify(t));try{var d=await fetch(l,{method:"POST",headers:c,body:JSON.stringify(t)});if(d.ok)return await d.json();throw await d.json()}catch(e){_apiExceptionHandler(e,"Create Playlist Failed")}}async function _updateScheduleItemAsset(e,t,i,a,n,o,r,s,l,c){var d=t+`/admin/schedule/${i}/item/`+a,p=new Headers,e=(p.append("Content-Type","application/json"),p.append("Authorization","Bearer "+e),await _getScheduleItem(e,t,i,a,c)),t={asset:n||e.asset,days:o||e.days,durationTimeCode:r||e.durationTimeCode,endTimeCode:s||e.endTimeCode,id:a,scheduleItemType:"1",sourceType:"3",timeCode:l||e.timeCode};c&&console.log(`URL: ${d}
METHOD: PUT
...
METHOD: PUT
BODY: `+JSON.stringify(t));try{var _=await fetch(w,{method:"PUT",headers:m,body:JSON.stringify(t)});if(_.ok)return await _.json();throw await _.json()}catch(e){_apiExceptionHandler(e,"Update Schedule Item Failed")}}async function _changeSessionStatus(e,t,i,a,n,o){var t=t+"/admin/user-session",r=new Headers,e=(r.append("Content-Type","application/json"),r.append("Authorization","Bearer "+e),{id:i,userSessionStatus:a,applicationId:n});o&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: DELETE`);try{var n=await fetch(t,{method:"DELETE",headers:i});if(!n.ok)throw await n.json()}catch(e){_apiExceptionHandler(e,"Delete User Session Data Failed")}}async function _deleteUserVideoTrackingData(e,t,i,a,n,o,r,s,l,c,d,p,h,u,f,g,y,w,m){var t=t+"/admin/user/userVideoTracking/delete",_=new Headers,e=(_.append("Content-Type","application/json"),_.append("Authorization","Bearer "+e),{assetId:i,contentId:a,videoTrackingAttribute:n,userId:o,id:r,isFirstQuartile:s,isMidpoint:l,isThirdQuartile:c,isComplete:d,isHidden:p,isLiveStream:h,maxSecond:u,lastSecond:f,totalSeconds:g,lastBeaconDate:y,keyName:w});m&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: GET`);try{var r=await fetch(o,{method:"GET",headers:i});if(r.ok)return await r.json();throw await r.json()}catch(e){_apiExceptionHandler(e,"Participant panel query failed")}}async function _ping(e,t,i,a){var t=t+"/account/ping",n=new Headers,e=(n.append("Content-Type","application/json"),n.append("Authorization","Bearer "+e),{userId:a});i&&(e.applicationId=i);try{var o=await fetch(t,{method:"POST",headers:n,body:JSON.stringify(e)});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Ping user failed")}}async function _registerGuest(e,t,i,a,n,o,r){var t=t+"/account/register-guest",s=new Headers,e=(s.append("Content-Type","application/json"),s.append("Authorization","Bearer "+e),{email:i,firstName:a,lastName:n,password:o});r&&console.log(`URL: ${t}
METHOD: POST
