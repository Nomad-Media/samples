...
METHOD: POST
BODY: `+JSON.stringify(t,null,4));try{var o=await fetch(e,{method:"POST",headers:i,body:JSON.stringify(t)});if(o.ok)return await o.json();throw await o.json()}catch(t){_apiExceptionHandler(t,"Creating Form Failed")}}async function _getDefaultSiteConfig(t,e,i){var e=e+"/media/config",n=new Headers;n.append("Content-Type","application/json"),n.append("Authorization","Bearer "+t),i&&console.log(`URL: ${e}
