...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var s=await fetch(t,{method:"POST",headers:r,body:JSON.stringify(e)});if(s.ok)return await s.json();throw await s.json()}catch(e){_apiExceptionHandler(e,"Adding Related Content Failed")}}async function _addTagOrCollection(e,t,i,n,a,o,r,s,c){var t=t+`/admin/${i}/content`,l=new Headers,e=(l.append("Content-Type","application/json"),l.append("Authorization","Bearer "+e),{items:[{contentDefinition:a,contentId:n,name:o,createNew:s}]});null!=r&&(e.items[0][i+"Id"]=r),c&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var p=await fetch(t,{method:"POST",headers:l,body:JSON.stringify(e)});if(p.ok)return await p.json();throw await p.json()}catch(e){_apiExceptionHandler(e,"Adding Tag or Collection Failed")}}async function _createTagOrCollection(e,t,i,n,a){t=t+"/admin/"+i,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={name:n};a&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: POST`);try{var o=await fetch(t,{method:"DELETE",headers:i});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Delete Tag or Collection Failed")}}async function _getTagOrCollection(e,t,i,n,a){t=t+`/admin/${i}/`+n,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: GET`);try{var o=await fetch(t,{method:"GET",headers:i});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Getting Tag or Collection Failed")}}async function _removeTagOrCollection(e,t,i,n,a,o,r){var t=t+`/admin/${i}/content/delete`,s=new Headers,e=(s.append("Content-Type","application/json"),s.append("Authorization","Bearer "+e),{items:[{contentDefinition:a,contentId:n}]});e.items[0][i+"Id"]=o,r&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var c=await fetch(t,{method:"POST",headers:s,body:JSON.stringify(e)});if(c.ok)return await c.json();throw await c.json()}catch(e){_apiExceptionHandler(e,"Removing Tag or Collection Failed")}}async function _createContent(e,t,i,n,a){let o=t+"/content/new?contentDefinitionId="+i;t=new Headers;t.append("Content-Type","application/json"),t.append("Authorization","Bearer "+e),n&&(o+="&language="+n),a&&console.log(`URL: ${o}
...
METHOD: GET`);try{var s=await fetch(r,{method:"GET",headers:t});if(s.ok)return await s.json();throw await s.json()}catch(e){_apiExceptionHandler(e,"Get Content Failed")}}import deepEqual from"deep-equal";async function _updateContent(e,t,i,n,a,o,r){var s=t+"/content/"+i,c=new Headers;c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e);let l=null;try{(l=await _getContent(e,t,i,n,null,r)).contentDefinitionId!==n&&(l.contentDefinitionId=n),l.contentId!==i&&(l.contentId=i),l.languageId!==o&&(l.languageId=o),_updateProperties(l,a)}catch(e){l={contentDefinitionId:n,contentId:i,languageId:o,properties:a}}r&&console.log(`URL: ${s}
METHOD: PUT
BODY: `+JSON.stringify(l,null,4));try{var p=await fetch(s,{method:"PUT",headers:c,body:JSON.stringify(l)});if(p.ok)return await p.json();throw await p.json()}catch(e){_apiExceptionHandler(e,"Update Content Failed")}}function _updateProperties(t,i){for(const n in i)if(Array.isArray(i[n]))for(let e=0;e<i[n].length;++e)deepEqual(t.properties[n][e],i[n][e])||(t.properties[n][e]=i[n][e]);else"object"==typeof i[n]?deepEqual(t.properties[n],i[n])||(t.properties[n]=i[n]):t.properties[n]!==i[n]&&(t.properties[n]=i[n])}async function _addLiveScheduleToEvent(e,t,i,n,a,o,r,s,c,l,p,d,h,u){var t=t+"/admin/liveSchedule",f=new Headers,e=(f.append("Content-Type","application/json"),f.append("Authorization","Bearer "+e),{contentId:i,slateVideo:null!==n?n:"",prerollVideo:null!==a?a:"",postrollVideo:null!==o?o:"",isSecureOutput:null!==r&&r,archiveFolderAsset:null!==s?s:"",primaryLiveInput:null!==c?c:"",backupLiveInputId:null!==l?l:"",primaryLivestreamInputUrl:null!==p?p:"",backupLivestreamInputUrl:null!==d?d:"",externalOutputProfiles:null!==h?h:""});u&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var g=await fetch(t,{method:"POST",headers:f,body:JSON.stringify(e)});if(!g.ok)throw await g.json()}catch(e){_apiExceptionHandler(e,"Adding Live Schedule to Event Failed")}}async function _createAndUpdateEvent(e,t,i,n,a,o,r,s,c,l,p,d,h,u,f,g,w,y,v,m,_,T,D,E,S,C,O,A,U,L){var k=new Headers;if(k.append("Content-Type","application/json"),k.append("Authorization","Bearer "+e),null===i){e=t+"/content/new?contentDefinitionId="+n;L&&console.log(`URL: ${e}
METHOD: GET`);try{var H=await fetch(e,{method:"GET",headers:k});if(!H.ok)throw await H.json();i=(await H.json()).contentId}catch(e){_apiExceptionHandler(e,"Get Content ID Failed")}}e=t+"/content/"+i,H={contentId:i,contentDefinitionId:n,properties:{contentRatings:null!==O?O:"",disabled:null!==A&&A,endDatetime:s,externalUrl:null!==g?g:"",featuredGroups:null!==D?D:[],genres:null!==v?v:[],groupSequence:null!==E?E:"",heroImage:null!==h?h:"",intelligentProgram:null!==f?f:"",languages:null!==_?_:[],liveChannel:null!==U?U:"",logoImage:null!==u?u:"",longDescription:null!==p?p:"",mediaAttributes:null!==m?m:[],name:a,performers:null!==y?y:[],primaryPerformer:null!==c?c:"",products:null!==T?T:[],recommendationSimilarItems:null!==C?C:[],relatedMediaItems:null!==S?S:[],routeName:_slugify(a),series:null!==o?o:"",shortDescription:null!==l?l:"",startDatetime:r,thumbnailImage:null!==d?d:"",venue:null!==w?w:""}};L&&console.log(`URL: ${e}
METHOD: PUT
BODY: `+JSON.stringify(H,null,4));try{var b=await fetch(e,{method:"PUT",headers:k,body:JSON.stringify(H)});if(b.ok)return await b.json();throw await b.json()}catch(e){_apiExceptionHandler(e,"Create and Update Event Instance Failed")}}async function _deleteEvent(e,t,i,n,a){t=t+`/content/${i}?contentDefinitionId=`+n,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
...
METHOD: POST`);try{var a=await fetch(t,{method:"POST",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Stop Live Schedule Failed")}}async function _createLiveChannel(e,t,i,n,a,o,r,s,c,l,p,d,h,u){var f=t+"/liveChannel",g=new Headers,i=(g.append("Content-Type","application/json"),g.append("Authorization","Bearer "+e),{name:i,routeName:_slugify(i),enableHighAvailability:o,enableLiveClipping:r,externalOutputProfiles:d,isSecureOutput:s,outputScreenshots:c,type:{id:_LIVE_CHANNEL_TYPES[l],descrption:l}});n&&(i.thumbnailImage={id:n}),a&&(i.archiveFolderAsset={id:a}),"External"===l&&(i.externalUrl=p),h&&(o=await _getSecurityGroups(e,t,u),i.securityGroups=o.filter(e=>h.includes(e.description)).map(e=>({description:e.description,id:e.id}))),u&&console.log(`URL: ${f}
METHOD: POST
...
METHOD: POST`);try{var r=await fetch(a,{method:"POST",headers:o});if(!r.ok)throw await r.json();await _waitForLiveChannelStatus(e,t,i,_LIVE_CHANNEL_STATUSES.Idle,1200,20,n)}catch(e){_apiExceptionHandler(e,"Stop Live Channel Failed")}}async function _updateLiveChannel(e,t,i,n,a,o,r,s,c,l,p,d,h,u,f){var i=await _getLiveChannel(e,t,i,f),g=t+"/liveChannel",w=new Headers;w.append("Content-Type","application/json"),w.append("Authorization","Bearer "+e);n&&n!==i.name&&(i.name=n,i.routeName=_slugify(n)),a&&a!==i.thumbnailImage&&(i.thumbnailImage={id:a}),o&&o!==i.archiveFolderAsset.id&&(i.archiveFolderAsset={id:o}),r&&r!==i.enableHighAvailability&&(i.enableHighAvailability=r),s&&s!==i.enableLiveClipping&&(i.enableLiveClipping=s),c&&c!==i.isSecureOutput&&(i.isSecureOutput=c),l&&l!==i.outputScreenshots&&(i.outputScreenshots=l),p&&_LIVE_CHANNEL_STATUSES[p]!==i.type.id&&(i.type={id:_LIVE_CHANNEL_TYPES[p]}),h&&h!==i.externalOutputProfiles&&(i.externalOutputProfiles=h),"External"===p?d&&d!==i.externalUrl&&(i.externalUrl=d):d&&i.externalUrl&&delete i.externalUrl,u&&(n=(await _getSecurityGroups(e,t,f)).filter(e=>u.includes(e.description)).map(e=>({description:e.description,id:e.id})))!==i.securityGroups&&(i.securityGroups=n),f&&console.log(`URL: ${g}
METHOD: POST
BODY: `+JSON.stringify(i,null,4));try{var y,v=await fetch(g,{method:"PUT",headers:w,body:JSON.stringify(i)});if(v.ok)return await _waitForLiveChannelStatus(e,t,(y=await v.json()).id,_LIVE_CHANNEL_STATUSES.Idle,120,2,f),y;throw await v.json()}catch(e){_apiExceptionHandler(e,"Updating Live Channel Failed")}}async function _waitForLiveChannelStatus(e,t,i,n,a=30,o=2,r){var s=(new Date).getTime();let c=0;for(;c<a;){var l=await _getLiveChannelStatus(e,t,i,r);if(l===n)return void(r&&console.log(`Live Channel [${i}] transitioned to status [${n}]`));if(console.log(`Live Channel [${i}] current status is [${l}]`),"Error"===l)throw l=await _getLiveChannelStatusMessage(e,t,i,r),new Error(`Live Channel [${i}] is in [Error] status: `+l);if(c=((new Date).getTime()-s)/1e3,r&&console.log(`Waiting for Live Channel [${i}] to transition to status [${n}]... [${Math.round(c)}/${a}]`),c>a)break;await _sleep(o)}throw new Error(`Waiting for Live Channel [${i}] to transition to status [${n}] timed out`)}async function _createLiveInput(e,t,i,n,a,o,r,s,c,l){var p=t+"/liveInput",d=new Headers,i=(d.append("Content-Type","application/json"),d.append("Authorization","Bearer "+e),{name:i,internalName:_slugify(i),type:{id:_LIVE_INPUT_TYPES[a],description:a}});"RTMP_PUSH"==a?n&&(i.sourceCidr=n):"RTMP_PULL"!==a&&"RTP_PUSH"!==a&&"URL_PULL"!==a||n&&(i.sources=[{url:n}]),o&&(i.isStandard=o),r&&(i.videoAsset={id:r}),s&&(i.destinations=s),c&&(i.sources=c),l&&console.log(`URL: ${p}
METHOD: POST
BODY: `+JSON.stringify(i,null,4));try{var h=await fetch(p,{method:"POST",headers:d,body:JSON.stringify(i)}),u=await h.json();if(h.ok)return await _waitForLiveInputStatus(e,t,u.id,_LIVE_INPUT_STATUSES.Detached,15,1,l),u;throw await h.json()}catch(e){_apiExceptionHandler(e,"Creating Live Input Failed")}}async function _deleteLiveInput(e,t,i,n){t=t+"/liveInput/"+i,i=new Headers;i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
...
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:n});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get Live Operators Failed")}}async function _startBroadcast(e,t,i,n,a,o,r,s,c){var l=t+"/admin/liveOperator/start",p=new Headers,d=(p.append("Authorization","Bearer "+e),p.append("Content-Type","application/json"),{id:i});n&&(d.prerollAsset={id:n}),a&&(d.postrollAsset={id:a}),o&&(d.liveInput={id:o}),r&&Array.isArray(r)&&0<r.length&&(d.relatedContent=r.map(e=>({id:e}))),s&&Array.isArray(s)&&0<s.length&&(d.tags=s.map(e=>({id:e}))),c&&console.log(`URL: ${l}
METHOD: POST
...
METHOD: POST`);try{var r=await fetch(a,{method:"POST",headers:o});if(!r.ok)throw await r.json();await _waitForLiveOperatorStatus(e,t,i,"Idle",1200,20)}catch(e){_apiExceptionHandler(e,"Stop Broadcast Failed")}}async function _waitForLiveOperatorStatus(e,t,i,n,a=30,o=2,r){var s=(new Date).getTime();let c=0;for(;c<a;){var l=(await _getLiveOperator(e,t,i,r)).liveChannelStatus.description;if(l===n)return void(r&&console.log(`Live Operator ${i} transitioned to status `+n));if(console.log(`Live Operator [${i}] is in status [${l}]`),"Error"===l)throw new Error(`Live Operator ${i} is broken`);if(c=((new Date).getTime()-s)/1e3,r&&console.log(`Waiting for Live Operator [${i}] to transition to status [${n}]... [${Math.round(c)}/${a}]`),c>a)break;await _sleep(o)}throw new Error(`Waiting for Live Operator [${i}] to transition to status [${n}] timed out`)}async function _addAssetScheduleEvent(e,t,i,n,a,o,r,s){var t=t+`/LiveChannel/${i}/liveScheduleEvent`,c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),{isLoop:a,channelId:i,durationTimeCode:o,previousId:r,type:{id:_eventType.videoAsset,description:"Video Asset"},asset:n});s&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var l=await fetch(t,{method:"POST",headers:c,body:JSON.stringify(e)});if(l.ok)return(await l.json()).changeList[0];throw await l.json()}catch(e){_apiExceptionHandler(e,"Adding Asset Schedule Event Failed")}}async function _addInputScheduleEvent(e,t,i,n,a,o,r,s){var t=t+`/LiveChannel/${i}/liveScheduleEvent`,c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),{channelId:i,fixedOnAirTimeUtc:o,type:{id:_eventType.liveInput,description:"Live Input"},liveInput:n,previousId:r});a&&(e.liveInput2=a),s&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var l=await fetch(t,{method:"POST",headers:c,body:JSON.stringify(e)});if(l.ok)return(await l.json()).changeList[0];throw await l.json()}catch(e){_apiExceptionHandler(e,"Adding Input Schedule Event Failed")}}const _eventType={liveInput:"eef7ef23-56dc-4f48-8c0e-1f4d52990405",videoAsset:"eef7ef23-56dc-4f48-8c0e-1f4d52990404"};async function _getAssetScheduleEvent(e,t,i,n,a){t=t+`/liveChannel/${i}/liveScheduleEvent/`+n,i=new Headers;i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
...
METHOD: DELETE`);try{var o=await fetch(t,{method:"delete",headers:i});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Remove Input Schedule Event Failed")}}async function _updateAssetScheduleEvent(e,t,i,n,a,o,r,s){var c=await _getAssetScheduleEvent(e,t,n,i,s),t=t+`/LiveChannel/${n}/liveScheduleEvent`,l=new Headers,e=(l.append("Content-Type","application/json"),l.append("Authorization","Bearer "+e),{type:{id:_eventType.videoAsset,description:"Video Asset"}});e.id=i&&i!==c.id?i:c.id,e.isLoop=o&&o!==c.isLoop?o:c.isLoop,e.channelId=n&&n!==c.channelId?n:c.channelId,e.durationTimeCode=r&&r!==c.durationTimeCode?r:c.durationTimeCode,e.asset=a&&a!==c.asset?a:c.asset,s&&console.log(`URL: ${t}
METHOD: PUT
BODY: `+JSON.stringify(e,null,4));try{var p=await fetch(t,{method:"PUT",headers:l,body:JSON.stringify(e)});if(p.ok)return await p.json();throw await p.json()}catch(e){_apiExceptionHandler(e,"Updating Asset Schedule Event Failed")}}async function _updateInputScheduleEvent(e,t,i,n,a,o,r,s){var c=await _getInputScheduleEvent(e,t,n,i,s),t=t+`/LiveChannel/${n}/liveScheduleEvent`,l=new Headers,e=(l.append("Content-Type","application/json"),l.append("Authorization","Bearer "+e),{type:{id:_eventType.liveInput,description:"Live Input"}});e.id=i&&i!==c.id?i:c.id,e.channelId=n&&n!==c.channelId?n:c.channelId,e.fixedOnAirTimeUtc=r&&r!==c.fixedOnAirTimeUtc?r:c.fixedOnAirTimeUtc,e.liveInput=a&&a!==c.liveInput?a:c.liveInput,e.liveInput2=o&&o!==c.liveInput2?o:c.liveInput2,s&&console.log(`URL: ${t}
METHOD: PUT
BODY: `+JSON.stringify(e,null,4));try{var p=await fetch(t,{method:"PUT",headers:l,body:JSON.stringify(e)});if(p.ok)return await p.json();throw await p.json()}catch(e){_apiExceptionHandler(e,"Updating Input Schedule Event Failed")}}async function _changeSessionStatus(e,t,i,n,a,o){var t=t+"/admin/user-session",r=new Headers,e=(r.append("Content-Type","application/json"),r.append("Authorization","Bearer "+e),{id:i,userSessionStatus:n,applicationId:a});o&&console.log(`URL: ${t}
METHOD: POST
BODY: `+e);try{var s=await fetch(t,{method:"POST",headers:r,body:e});if(s.ok)return await s.json();throw await s.json()}catch(e){_apiExceptionHandler(e,"Change Session Status Failed")}}async function _getUserSession(e,t,i,n){t=t+"/admin/user-session/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:i});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get User Session Failed")}}async function _deleteUserContentAttributeData(e,t,i,n){t=t+"/admin/user/userContentAttribute/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var a=await fetch(t,{method:"DELETE",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Delete User Content Attribute Data Failed")}}async function _deleteUserContentGroupData(e,t,i,n){t=t+"/admin/user/contentGroup/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var a=await fetch(t,{method:"DELETE",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Delete User Content Group Data Failed")}}async function _deleteUserContentSecurityData(e,t,i,n,a,o,r,s,c,l){var t=t+"/admin/user/userContentSecurity/delete",p=new Headers,e=(p.append("Content-Type","application/json"),p.append("Authorization","Bearer "+e),{contentId:i,contentDefinitionId:n,userId:a,email:o,id:r,keyName:s,expirationDate:c});l&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var d=await fetch(t,{method:"POST",headers:p,body:JSON.stringify(e)});if(!d.ok)throw await d.json()}catch(e){_apiExceptionHandler(e,"Delete User Content Security Data Failed")}}async function _deleteUserData(e,t,i,n){t=t+"/admin/user/userData/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var a=await fetch(t,{method:"DELETE",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Delete User Data Failed")}}async function _deleteUserDislikesData(e,t,i,n){t=t+"/admin/user/dislike/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var a=await fetch(t,{method:"DELETE",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Delete User Dislikes Data Failed")}}async function _deleteUserFavoritesData(e,t,i,n){t=t+"/admin/user/favorite/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var a=await fetch(t,{method:"DELETE",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Delete User Favorites Data Failed")}}async function _deleteUserLikesData(e,t,i,n){t=t+"/admin/user/like/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var a=await fetch(t,{method:"DELETE",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Delete User Likes Data Failed")}}async function _deleteUserSavedSearchData(e,t,i,n){t=t+"/admin/user/savedSearch/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var a=await fetch(t,{method:"DELETE",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Delete User Saved Search Data Failed")}}async function _deleteUserSessionData(e,t,i,n){t=t+"/admin/user/userSession/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var a=await fetch(t,{method:"DELETE",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Delete User Session Data Failed")}}async function _deleteUserVideoTrackingData(e,t,i,n,a,o,r,s,c,l,p,d,h,u,f,g,w,y,v){var t=t+"/admin/user/userVideoTracking/delete",m=new Headers,e=(m.append("Content-Type","application/json"),m.append("Authorization","Bearer "+e),{assetId:i,contentId:n,videoTrackingAttribute:a,userId:o,id:r,isFirstQuartile:s,isMidpoint:c,isThirdQuartile:l,isComplete:p,isHidden:d,isLiveStream:h,maxSecond:u,lastSecond:f,totalSecond:g,lastBeaconDate:w,keyName:y});v&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e));try{var _=await fetch(t,{method:"POST",headers:m,body:JSON.stringify(e)});if(!_.ok)throw await _.json()}catch(e){_apiExceptionHandler(e,"Delete User Video Tracking Data Failed")}}async function _deleteUser(e,t,i,n){t=t+"/admin/user/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: DELETE`);try{var a=await fetch(t,{method:"DELETE",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Delete User Failed")}}async function _register(e,t,i,n,a,o){var e=e+"/account/register",r=new Headers,i=(r.append("Content-Type","application/json"),{firstName:i,lastName:n,email:t,password:a});o&&console.log(`URL: ${e}
METHOD: POST
...
METHOD: GET`);try{var o=await fetch(n,{method:"GET",headers:t});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Get Asset Details Failed")}}async function _search(e,t,i,n,a,o,r,s,c,l,p,d,h,u){t+=`/${h}/search`,h=new Headers,h.append("Content-Type","application/json"),h.append("Authorization","Bearer "+e),e={};i&&(e.query=i),e.pageOffset=n||0,e.pageSize=a||100,o&&(e.filters=o),r&&(e.sortFields=r),s&&(e.searchResultFields=s),c&&(e.similarAssetId=c),l&&(e.minScore=l),p&&(e.excludeTotalRecordCount=p),d&&(e.filterBinder=d),u&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:n});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get user failed")}}async function _updateUser(e,t,i,n,a,o,r,s,c,l,p,d,h,u){var f,g=await _getUser(e,t,u),w=t+"/account/user",y=new Headers,v=(y.append("Content-Type","application/json"),y.append("Authorization","Bearer "+e),{}),m=(await _getCountries(e,t,u)).find(e=>e.label===o),_={address:i,address2:n,city:a,state:(await _getStates(e,t,u)).find(e=>e.label===h).label,country:m,firstName:r,lastName:s,phone:l,phoneExt:p,postalCode:d,organization:c};for(const D in _)null!==_[D]?v[D]=_[D]:null!=(f=g[D])&&(v[D]=f);u&&console.log(`URL: ${w}
METHOD: PUT
...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var o=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Stop Sharing Content Group With Users Failed")}}async function _guestInvite(e,t,i,n,a,o,r,s){var t=t+"/account/invite-user",c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),{contentId:i,contentDefinitionId:n,userId:a,emails:o,contentSecurityAttribute:r});s&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var l=await fetch(t,{method:"POST",headers:c,body:JSON.stringify(e)});if(l.ok)return await l.json();throw await l.json()}catch(e){_apiExceptionHandler(e,"Guest Invite failed")}}async function _participantPanelQuery(e,t,i,n,a){let o="";o="admin"==i?t+"/admin/user-session/"+n:t+"/user-session/"+n;i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${o}
...
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var c=await fetch(t,{method:"POST",headers:s,body:JSON.stringify(e)});if(c.ok)return await c.json();throw await c.json()}catch(e){_apiExceptionHandler(e,"Register guest failed")}}async function _removeGuest(e,t,i,n,a,o,r,s){var t=t+"/account/remove-user",c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),{contentId:i,contentDefinitionId:n,userId:a,emails:o,contentSecurityAttribute:r});s&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var l=await fetch(t,{method:"POST",headers:c,body:JSON.stringify(e)});if(l.ok)return await l.json();throw await l.json()}catch(e){_apiExceptionHandler(e,"Remove guest failed")}}async function _clearContinueWatching(e,t,i,n,a){var t=t+"/media/clear-watching",o=[],i=(i&&o.push("userId="+i),n&&o.push("assetId="+n),t+=o.length?"?"+o.join("&"):"",new Headers);i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
METHOD: POST`);try{var r=await fetch(t,{method:"POST",headers:i});if(!r.ok)throw await r.json()}catch(e){_apiExceptionHandler(e,"Clear Continue Watching Failed")}}async function _clearWatchlist(e,t,i,n){t=t+"/media/clear-watchlist?userId="+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: POST`);try{var a=await fetch(t,{method:"POST",headers:i});if(!a.ok)throw await a.json()}catch(e){_apiExceptionHandler(e,"Clear Watchlist Failed")}}async function _createForm(e,t,i,n,a){t=t+"/media/form/"+i,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e=n;a&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var o=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(o.ok)return await o.json();throw await o.json()}catch(e){_apiExceptionHandler(e,"Creating Form Failed")}}async function _getContentCookies(e,t,i,n){t=t+"/media/set-cookies/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:i});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get Content Cookies Failed")}}async function _getDefaultSiteConfig(e,t,i){var t=t+"/media/config",n=new Headers;n.append("Content-Type","application/json"),n.append("Authorization","Bearer "+e),i&&console.log(`URL: ${t}
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:n});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get Default Site Config Failed")}}async function _getDynamicContent(e,t,i,n){t=t+"/media/content/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:i});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get Dynamic Content Failed")}}async function _getDynamicContents(e,t,i){var t=t+"/media/content",n=new Headers;n.append("Content-Type","application/json"),n.append("Authorization","Bearer "+e),i&&console.log(`URL: ${t}
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:n});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get Dynamic Contents Failed")}}async function _getMediaGroup(e,t,i,n){t=t+"/media/group/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:i});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get Media Group Failed")}}async function _getMediaItem(e,t,i,n){t=t+"/media/item/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:i});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get Media Item Failed")}}async function _getMyContent(e,t,i){var t=t+"/media/my-content",n=new Headers;n.append("Content-Type","application/json"),n.append("Authorization","Bearer "+e),i&&console.log(`URL: ${t}
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:n});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get My Content Failed")}}async function _getMyGroup(e,t,i,n){t=t+"/media/my-group/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:i});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get My Group Failed")}}async function _getSiteConfig(e,t,i,n){t=t+"/media/config/"+i,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),n&&console.log(`URL: ${t}
METHOD: GET`);try{var a=await fetch(t,{method:"GET",headers:i});if(a.ok)return await a.json();throw await a.json()}catch(e){_apiExceptionHandler(e,"Get Site Config Failed")}}async function _mediaSearch(e,t,i,n,a,o,r,s){var t=t+"/media/search",c=new Headers,e=(c.append("Content-Type","application/json"),c.append("Authorization","Bearer "+e),{searchQuery:i,ids:n,sortFields:a});e.pageOffset=o||0,e.pageSize=r||100,s&&console.log(`URL: ${t}
METHOD: POST
BODY: `+JSON.stringify(e,null,4));try{var l=await fetch(t,{method:"POST",headers:c,body:JSON.stringify(e)});if(l.ok)return await l.json();throw await l.json()}catch(e){_apiExceptionHandler(e,"Media Search Failed")}}async function _getVideoTracking(e,t,i,n,a,o){let r=t+"/asset/tracking?assetId="+i;t=new Headers;t.append("Content-Type","application/json"),t.append("Authorization","Bearer "+e),n&&(r+="&trackingEvent="+n),a&&(r+="&second="+a),o&&console.log(`URL: ${r}
