...
METHOD: POST
BODY: `+JSON.stringify(n));try{var r=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(n)});if(r.ok)return await r.json();throw await r.json()}catch(e){_apiExceptionHandler(e,"Transcribe Asset Failed")}}async function _updateAnnotation(e,t,i,a,n,o,r,s,l,c){var d=t+`/asset/${i}/annotation/`+a,p=new Headers;p.append("Content-Type","application/json"),p.append("Authorization","Bearer "+e);e=(await _getAnnotations(e,t,i,c)).find(e=>e.id===a),t={id:a||e.id,startTimeCode:n||e.startTimeCode,endTimeCode:o||e.endTimeCode,properties:r||e.properties,contentId:s||e.contentId,imageUrl:l||e.imageUrl};c&&console.log(`URL: ${d}
METHOD: PUT
BODY: `+JSON.stringify(t));try{var h=await fetch(d,{method:"PUT",headers:p,body:JSON.stringify(t)});if(h.ok)return await h.json();throw await h.json()}catch(e){_apiExceptionHandler(e,"Update Annotations Failed")}}async function _updateAssetAdBreak(e,t,i,a,n,o,r,s){t=t+`/admin/asset/${i}/adbreak/`+a,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={id:a,timeCode:n,tags:o,labels:r};s&&console.log(`URL: ${t}
METHOD: PUT
