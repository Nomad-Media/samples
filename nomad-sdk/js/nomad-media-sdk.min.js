...
METHOD: POST
BODY: `+JSON.stringify(e));try{var p=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(p.ok)return await p.json();throw await p.json()}catch(e){_apiExceptionHandler(e,"Copy Asset Failed")}}async function _createAnnotation(e,t,i,a,n,o,r,s,l,c){t=t+`/admin/asset/${i}/annotation/`+a,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),c&&console.log(`URL: ${t}
METHOD: POST`),e={id:a,startTimeCode:n,endTimeCode:o,properties:r,contentId:s,imageUrl:l};try{var d=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(e)});if(d.ok)return await d.json();throw await d.json()}catch(e){_apiExceptionHandler(e,"Create Annotation Failed")}}async function _createAssetAdBreak(e,t,i,a,n,o,r){var t=t+`/admin/asset/${i}/adbreaks`,s=new Headers,e=(s.append("Content-Type","application/json"),s.append("Authorization","Bearer "+e),{id:i,timeCode:a,tags:n,labels:o});r&&console.log(`URL: ${t}
METHOD: POST
...
METHOD: GET`);try{var n=await fetch(t,{method:"GET",headers:i});if(n.ok)return await n.json();throw await n.json()}catch(e){_apiExceptionHandler(e,"Get Annotations Failed")}}async function _getAssetAdBreaks(e,t,i,a){t+=`/admin/asset/${i}/adbreaks`,i=new Headers;i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),a&&console.log(`URL: ${t}
...
METHOD: POST
BODY: `+JSON.stringify(n));try{var r=await fetch(t,{method:"POST",headers:i,body:JSON.stringify(n)});if(r.ok)return await r.json();throw await r.json()}catch(e){_apiExceptionHandler(e,"Transcribe Asset Failed")}}async function _updateAnnotation(e,t,i,a,n,o,r,s,l,c){t=t+`/admin/asset/${i}/annotation/`+a,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={id:a,startTimeCode:n,endTimeCode:o,properties:r,contentId:s,imageUrl:l};c&&console.log(`URL: ${t}
METHOD: PUT
BODY: `+JSON.stringify(e));try{var d=await fetch(t,{method:"PUT",headers:i,body:JSON.stringify(e)});if(d.ok)return await d.json();throw await d.json()}catch(e){_apiExceptionHandler(e,"Update Annotations Failed")}}async function _updateAssetAdBreak(e,t,i,a,n,o,r,s){t=t+`/admin/asset/${i}/adbreaks/`+a,i=new Headers,i.append("Content-Type","application/json"),i.append("Authorization","Bearer "+e),e={id:a,timeCode:n,tags:o,labels:r};s&&console.log(`URL: ${t}
METHOD: PUT
